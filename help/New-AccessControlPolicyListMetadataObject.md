...
# New-AccessControlPolicyListMetadataObject
...
```
New-AccessControlPolicyListMetadataObject [-Filter <String>] [-Kind <String>] [-Length <Int32>]
 [-Offset <Int32>] [-SortAttribute <String>] [<CommonParameters>]
```
