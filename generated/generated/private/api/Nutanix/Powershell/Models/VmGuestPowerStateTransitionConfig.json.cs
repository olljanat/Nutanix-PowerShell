namespace Nutanix.Powershell.Models
{
    ...
    public partial class VmGuestPowerStateTransitionConfig
    {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="VmGuestPowerStateTransitionConfig" /> into a <see cref="Carbon.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Carbon.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Microsoft.Rest.ClientRuntime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="VmGuestPowerStateTransitionConfig" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != EnableScriptExec ? (Carbon.Json.JsonNode)new Carbon.Json.JsonBoolean((bool)EnableScriptExec) : null, "enable_script_exec" ,container.Add );
            AddIf( null != ShouldFailOnScriptFailure ? (Carbon.Json.JsonNode)new Carbon.Json.JsonBoolean((bool)ShouldFailOnScriptFailure) : null, "should_fail_on_script_failure" ,container.Add );
