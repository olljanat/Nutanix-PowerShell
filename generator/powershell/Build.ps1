...
$Manifest = @{
    ...
    Description = 'Org.OpenAPITools - the PowerShell module for Swagger Petstore'

    RootModule = 'Org.OpenAPITools.psm1'
    Guid = '{C883F37E-E467-429F-A87B-27D4E35F4752}' # Has to be static, otherwise each new build will be considered different module
