namespace Nutanix.Powershell.Models
{
    ...
    public partial class ProceduralErrorResponse
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Nutanix.Powershell.Models.IProceduralErrorResponse.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Nutanix.Powershell.Models.IProceduralErrorResponse.</returns>
        public static Nutanix.Powershell.Models.IProceduralErrorResponse FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new ProceduralErrorResponse(json) : null;
        }
        /// <summary>
        /// Deserializes a Carbon.Json.JsonObject into a new instance of <see cref="ProceduralErrorResponse" />.
        /// </summary>
        /// <param name="json">A Carbon.Json.JsonObject instance to deserialize from.</param>
        internal ProceduralErrorResponse(Carbon.Json.JsonObject json)
        {
