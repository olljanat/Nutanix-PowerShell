namespace Nutanix.Powershell.Models
{
    ...
    public partial class Image
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Nutanix.Powershell.Models.IImage.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Nutanix.Powershell.Models.IImage.</returns>
        public static Nutanix.Powershell.Models.IImage FromJson(Carbon.Json.JsonNode node)
        {
        ...
        internal Image(Carbon.Json.JsonObject json)
        {
            ...
            _resources = If( json?.PropertyT<Carbon.Json.JsonObject>("resources"), out var __jsonResources) ? Nutanix.Powershell.Models.ImageResources.FromJson(__jsonResources) : Resources;
            AfterFromJson(json);
        }
        /// <summary>
