namespace Sample.API.Models
{
    ...
    public partial class VmRecoveryPointListMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IVmRecoveryPointListMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IVmRecoveryPointListMetadata.</returns>
        public static Sample.API.Models.IVmRecoveryPointListMetadata FromJson(Carbon.Json.JsonNode node)
        {
