namespace Sample.API.Models
{
    ...
    public partial class UserDefStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IUserDefStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IUserDefStatus.</returns>
        public static Sample.API.Models.IUserDefStatus FromJson(Carbon.Json.JsonNode node)
        {
        ...
        internal UserDefStatus(Carbon.Json.JsonObject json)
        {
            ...
            _resources = If( json?.PropertyT<Carbon.Json.JsonObject>("resources"), out var __jsonResources) ? Sample.API.Models.UserStatusResource.FromJson(__jsonResources) : Resources;
