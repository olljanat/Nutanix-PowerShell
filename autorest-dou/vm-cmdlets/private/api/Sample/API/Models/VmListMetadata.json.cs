namespace Sample.API.Models
{
    ...
    public partial class VmListMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IVmListMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IVmListMetadata.</returns>
        public static Sample.API.Models.IVmListMetadata FromJson(Carbon.Json.JsonNode node)
        {
