namespace Sample.API.Models
{
    ...
    public partial class VmMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IVmMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IVmMetadata.</returns>
        public static Sample.API.Models.IVmMetadata FromJson(Carbon.Json.JsonNode node)
        {
