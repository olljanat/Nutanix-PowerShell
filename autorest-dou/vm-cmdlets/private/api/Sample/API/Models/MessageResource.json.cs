namespace Sample.API.Models
{
    ...
    public partial class MessageResource
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IMessageResource.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IMessageResource.</returns>
        public static Sample.API.Models.IMessageResource FromJson(Carbon.Json.JsonNode node)
        {
        ...
        internal MessageResource(Carbon.Json.JsonObject json)
        {
            ...
            _details = null /* deserializeFromContainerMember (wildcard) doesn't support 'application/json' C:\Users\hugo1\Documents\autorest\autorest.incubator\dist\csharp\schema\wildcard.js*/;
            AfterFromJson(json);
        }
        /// <summary>
