namespace Sample.API.Models
{
    ...
    public partial class GuestCustomizationStatusSysprep
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IGuestCustomizationStatusSysprep.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IGuestCustomizationStatusSysprep.</returns>
        public static Sample.API.Models.IGuestCustomizationStatusSysprep FromJson(Carbon.Json.JsonNode node)
        {
