namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IAccessControlPolicyListIntentResponse))]
    public class GetServiceOperation_OperationFilterKindLengthOffsetSortAttributeExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.IAccessControlPolicyListMetadata _getEntitiesRequest= new Sample.API.Models.AccessControlPolicyListMetadata();

        /// <summary>
        /// All api calls that return a list will have this metadata block as input
        /// </summary>
        public Sample.API.Models.IAccessControlPolicyListMetadata GetEntitiesRequest
        {
            get
            {
        ...
        /// </returns>
        public Sample.API.Cmdlets.GetServiceOperation_OperationFilterKindLengthOffsetSortAttributeExpanded Clone()
        {
        ...
        /// </returns>
        public static Sample.API.Cmdlets.GetServiceOperation_OperationFilterKindLengthOffsetSortAttributeExpanded FromJson(Carbon.Json.JsonNode node)
        {
        ...
        /// cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetServiceOperation_OperationFilterKindLengthOffsetSortAttributeExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        ...
        internal GetServiceOperation_OperationFilterKindLengthOffsetSortAttributeExpanded(Carbon.Json.JsonObject json)
        {
            ...
            _getEntitiesRequest = If( json?.PropertyT<Carbon.Json.JsonObject>("GetEntitiesRequest"), out var __jsonGetEntitiesRequest) ? Sample.API.Models.AccessControlPolicyListMetadata.FromJson(__jsonGetEntitiesRequest) : GetEntitiesRequest;
        }
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IAccessControlPolicyStatus" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IAccessControlPolicyStatus> response)
        {
            using( NoSynchronizationContext )
            {
        ...
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IAccessControlPolicyListIntentResponse" /> from
        /// the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IAccessControlPolicyListIntentResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Sample.API.Models.IAccessControlPolicyListIntentResponse
