namespace Sample.API.Cmdlets
{
    ...
    public class InvokeVmService_FilterKindLengthOffsetSortAttributeSortOrder : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.IVmListMetadata _getEntitiesRequest;
        ...
        /// </returns>
        public Sample.API.Cmdlets.InvokeVmService_FilterKindLengthOffsetSortAttributeSortOrder Clone()
        {
        ...
        public static Sample.API.Cmdlets.InvokeVmService_FilterKindLengthOffsetSortAttributeSortOrder FromJson(Carbon.Json.JsonNode node)
        {
        ...
        /// </returns>
        public static Sample.API.Cmdlets.InvokeVmService_FilterKindLengthOffsetSortAttributeSortOrder FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
