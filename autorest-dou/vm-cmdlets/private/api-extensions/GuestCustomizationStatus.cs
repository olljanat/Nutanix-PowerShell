namespace Nutanix.Powershell.Models
{
    ...
    /// </summary>
    [System.ComponentModel.TypeConverter(typeof(GuestCustomizationStatusTypeConverter))]
    public partial class GuestCustomizationStatus
    {

        /// <summary>
        /// Creates a new instance of <see cref="GuestCustomizationStatus" />, deserializing the content from a json string.
        /// </summary>
        /// <param name="jsonText">a string containing a JSON serialized instance of this model.</param>
        /// <returns>an instance of the <see cref="className" /> model class.</returns>
        public static Nutanix.Powershell.Models.IGuestCustomizationStatus FromJsonString(string jsonText) => FromJson(Carbon.Json.JsonNode.Parse(jsonText));
    ...
    /// is set to "True" then the deployer can upload their own custom script.
    [System.ComponentModel.TypeConverter(typeof(GuestCustomizationStatusTypeConverter))]
    public partial interface IGuestCustomizationStatus {
