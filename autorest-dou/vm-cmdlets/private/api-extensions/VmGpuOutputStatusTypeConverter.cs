namespace Nutanix.Powershell.Models
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="VmGpuOutputStatus" />
    /// </summary>
    public class VmGpuOutputStatusTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        /// parameter.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="VmGpuOutputStatus"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="VmGpuOutputStatus" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="VmGpuOutputStatus" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        ...
        /// /> and <see cref="ignoreCase" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="VmGpuOutputStatus" />.</param>
        /// <returns>
        /// an instance of <see cref="VmGpuOutputStatus" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                VmGpuOutputStatus.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new VmGpuOutputStatus
                {
                Name = sourceValue.Name,
                DeviceId = sourceValue.DeviceId,
                Fraction = sourceValue.Fraction,
                FrameBufferSizeMib = sourceValue.FrameBufferSizeMib,
                GuestDriverVersion = sourceValue.GuestDriverVersion,
                Mode = sourceValue.Mode,
                NumVirtualDisplayHeads = sourceValue.NumVirtualDisplayHeads,
                PciAddress = sourceValue.PciAddress,
                Uuid = sourceValue.Uuid,
                Vendor = sourceValue.Vendor,
                };
            }
            catch
            {
