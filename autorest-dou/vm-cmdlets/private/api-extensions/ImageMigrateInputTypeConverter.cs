namespace Nutanix.Powershell.Models
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="ImageMigrateInput" />
    /// </summary>
    public class ImageMigrateInputTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        /// parameter.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="ImageMigrateInput"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="ImageMigrateInput" /> type, otherwise <c>false</c>
        /// </returns>
