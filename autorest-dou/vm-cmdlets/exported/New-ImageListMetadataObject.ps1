function New-ImageListMetadataObject {
[CmdletBinding()]
param(
...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('NutanixIntentfulAPI.private\New-ImageListMetadataObject', [System.Management.Automation.CommandTypes]::Cmdlet)
...
.ForwardHelpTargetName NutanixIntentfulAPI.private\New-ImageListMetadataObject
