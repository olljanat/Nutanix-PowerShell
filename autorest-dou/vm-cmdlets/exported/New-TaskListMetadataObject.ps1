function New-TaskListMetadataObject {
[CmdletBinding()]
param(
...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('NutanixIntentfulAPI.private\New-TaskListMetadataObject', [System.Management.Automation.CommandTypes]::Cmdlet)
...
.ForwardHelpTargetName NutanixIntentfulAPI.private\New-TaskListMetadataObject
