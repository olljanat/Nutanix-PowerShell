...
```
New-VmObject [-AvailabilityZoneReferenceName <String>] [-AvailabilityZoneReferenceUuid <String>]
 [-ClusterReferenceName <String>] -ClusterReferenceUuid <String> [-Description <String>] -Name <String>
 -Resources <IVmResources> [<CommonParameters>]
```
