namespace Sample.API.Models
{
    ...
    public partial class NetworkFunctionChainReference
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.INetworkFunctionChainReference.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.INetworkFunctionChainReference.</returns>
        public static Sample.API.Models.INetworkFunctionChainReference FromJson(Carbon.Json.JsonNode node)
        {
