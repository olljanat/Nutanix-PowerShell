namespace Sample.API.Models
{
    ...
    public partial class AccessControlPolicyStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IAccessControlPolicyStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IAccessControlPolicyStatus.</returns>
        public static Sample.API.Models.IAccessControlPolicyStatus FromJson(Carbon.Json.JsonNode node)
        {
