namespace Sample.API.Cmdlets
{
    ...
    public class GetServiceOperation_OperationFilterKindLengthOffsetSortAttribute : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.IAccessControlPolicyListMetadata _getEntitiesRequest;
        ...
        /// </returns>
        public Sample.API.Cmdlets.GetServiceOperation_OperationFilterKindLengthOffsetSortAttribute Clone()
        {
        ...
        /// </returns>
        public static Sample.API.Cmdlets.GetServiceOperation_OperationFilterKindLengthOffsetSortAttribute FromJson(Carbon.Json.JsonNode node)
        {
        ...
        /// </returns>
        public static Sample.API.Cmdlets.GetServiceOperation_OperationFilterKindLengthOffsetSortAttribute FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
