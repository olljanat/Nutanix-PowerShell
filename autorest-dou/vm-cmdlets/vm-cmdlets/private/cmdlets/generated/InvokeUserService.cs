namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IUserIntentResponse))]
    public class InvokeUserService : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.InvokeUserService Clone()
        {
        ...
        public static Sample.API.Cmdlets.InvokeUserService FromJson(Carbon.Json.JsonNode node)
        {
        ...
        public static Sample.API.Cmdlets.InvokeUserService FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IUserStatus" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IUserStatus> response)
        {
            using( NoSynchronizationContext )
            {
        ...
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IUserIntentResponse" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IUserIntentResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Sample.API.Models.IUserIntentResponse
