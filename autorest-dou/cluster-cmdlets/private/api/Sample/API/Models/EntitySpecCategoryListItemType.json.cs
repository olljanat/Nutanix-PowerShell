namespace Sample.API.Models
{
    ...
    public partial class EntitySpecCategoryListItemType
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IEntitySpecCategoryListItemType.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IEntitySpecCategoryListItemType.</returns>
        public static Sample.API.Models.IEntitySpecCategoryListItemType FromJson(Carbon.Json.JsonNode node)
        {
