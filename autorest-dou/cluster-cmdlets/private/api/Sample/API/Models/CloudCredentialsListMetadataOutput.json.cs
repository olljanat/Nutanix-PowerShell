namespace Sample.API.Models
{
    ...
    public partial class CloudCredentialsListMetadataOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ICloudCredentialsListMetadataOutput.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ICloudCredentialsListMetadataOutput.</returns>
        public static Sample.API.Models.ICloudCredentialsListMetadataOutput FromJson(Carbon.Json.JsonNode node)
        {
