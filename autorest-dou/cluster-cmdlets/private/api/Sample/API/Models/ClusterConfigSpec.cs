namespace Sample.API.Models
{
    ...
    public partial class ClusterConfigSpec : Sample.API.Models.IClusterConfigSpec, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        private Sample.API.Models.IExternalConfigurationsSpec _externalConfigurations;

        /// <summary>External Connector Configurations.</summary>
        public Sample.API.Models.IExternalConfigurationsSpec ExternalConfigurations
        {
            get
            {
    ...
    public partial interface IClusterConfigSpec : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        ...
        Sample.API.Models.IExternalConfigurationsSpec ExternalConfigurations { get; set; }
