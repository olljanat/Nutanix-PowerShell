namespace Sample.API.Models
{
    ...
    public partial class ClusterListMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IClusterListMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IClusterListMetadata.</returns>
        public static Sample.API.Models.IClusterListMetadata FromJson(Carbon.Json.JsonNode node)
        {
