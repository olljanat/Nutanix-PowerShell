namespace Sample.API.Models
{
    ...
    public partial class CloudCredentialsListMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ICloudCredentialsListMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ICloudCredentialsListMetadata.</returns>
        public static Sample.API.Models.ICloudCredentialsListMetadata FromJson(Carbon.Json.JsonNode node)
        {
