namespace Sample.API.Models
{
    ...
    public partial class ClusterStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IClusterStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IClusterStatus.</returns>
        public static Sample.API.Models.IClusterStatus FromJson(Carbon.Json.JsonNode node)
        {
