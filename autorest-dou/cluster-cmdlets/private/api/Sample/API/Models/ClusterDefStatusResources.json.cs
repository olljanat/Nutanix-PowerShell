namespace Sample.API.Models
{
    ...
    public partial class ClusterDefStatusResources
    {
        ...
        internal ClusterDefStatusResources(Carbon.Json.JsonObject json)
        {
            ...
            _analysis = If( json?.PropertyT<Carbon.Json.JsonObject>("analysis"), out var __jsonAnalysis) ? Sample.API.Models.ClusterAnalysis.FromJson(__jsonAnalysis) : Analysis;
            _config = If( json?.PropertyT<Carbon.Json.JsonObject>("config"), out var __jsonConfig) ? Sample.API.Models.ClusterConfig.FromJson(__jsonConfig) : Config;
            ...
            _nodes = If( json?.PropertyT<Carbon.Json.JsonObject>("nodes"), out var __jsonNodes) ? Sample.API.Models.ClusterNodes.FromJson(__jsonNodes) : Nodes;
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IClusterDefStatusResources.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IClusterDefStatusResources.</returns>
        public static Sample.API.Models.IClusterDefStatusResources FromJson(Carbon.Json.JsonNode node)
        {
