namespace Sample.API.Models
{
    ...
    public partial class CloudCredentialsStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ICloudCredentialsStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ICloudCredentialsStatus.</returns>
        public static Sample.API.Models.ICloudCredentialsStatus FromJson(Carbon.Json.JsonNode node)
        {
