namespace Sample.API.Models
{
    ...
    public partial class PlacementSpec : Sample.API.Models.IPlacementSpec, Microsoft.Rest.ClientRuntime.IValidates
    {
        /// <summary>Backing field for EntitySpecList property</summary>
        private Sample.API.Models.IEntitySpec[] _entitySpecList;
        ...
        /// <summary>Backing field for ProbableClusterReference property</summary>
        private Sample.API.Models.IClusterReference _probableClusterReference;
        ...
        /// </summary>
        public Sample.API.Models.IClusterReference ProbableClusterReference
        {
            get
            {
        ...
        /// <summary>Backing field for TenantUuid property</summary>
    ...
    public partial interface IPlacementSpec : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        Sample.API.Models.IEntitySpec[] EntitySpecList { get; set; }
        Sample.API.Models.IClusterReference ProbableClusterReference { get; set; }
