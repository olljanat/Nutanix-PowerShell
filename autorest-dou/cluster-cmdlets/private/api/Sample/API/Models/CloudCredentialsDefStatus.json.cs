namespace Sample.API.Models
{
    ...
    public partial class CloudCredentialsDefStatus
    {
        ...
        /// <summary>
        /// Deserializes a Carbon.Json.JsonObject into a new instance of <see cref="CloudCredentialsDefStatus" />.
        /// </summary>
        /// <param name="json">A Carbon.Json.JsonObject instance to deserialize from.</param>
        internal CloudCredentialsDefStatus(Carbon.Json.JsonObject json)
        {
            ...
            _id = If( json?.PropertyT<Carbon.Json.JsonNumber>("id"), out var __jsonId) ? (long)__jsonId : Id;
            ...
            _resources = If( json?.PropertyT<Carbon.Json.JsonObject>("resources"), out var __jsonResources) ? Sample.API.Models.CloudCredentialsResources.FromJson(__jsonResources) : Resources;
            _state = If( json?.PropertyT<Carbon.Json.JsonString>("state"), out var __jsonState) ? (string)__jsonState : (string)State;
            AfterFromJson(json);
        }
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ICloudCredentialsDefStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ICloudCredentialsDefStatus.</returns>
        public static Sample.API.Models.ICloudCredentialsDefStatus FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new CloudCredentialsDefStatus(json) : null;
        }
        /// <summary>
