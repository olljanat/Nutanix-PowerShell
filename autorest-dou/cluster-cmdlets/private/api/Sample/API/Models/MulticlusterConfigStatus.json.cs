namespace Sample.API.Models
{
    ...
    public partial class MulticlusterConfigStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IMulticlusterConfigStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IMulticlusterConfigStatus.</returns>
        public static Sample.API.Models.IMulticlusterConfigStatus FromJson(Carbon.Json.JsonNode node)
        {
