namespace Sample.API.Models
{
    ...
    public partial class ClusterDefStatus
    {
        ...
        internal ClusterDefStatus(Carbon.Json.JsonObject json)
        {
            ...
            _resources = If( json?.PropertyT<Carbon.Json.JsonObject>("resources"), out var __jsonResources) ? Sample.API.Models.ClusterDefStatusResources.FromJson(__jsonResources) : Resources;
            _state = If( json?.PropertyT<Carbon.Json.JsonString>("state"), out var __jsonState) ? (string)__jsonState : (string)State;
            AfterFromJson(json);
        }
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IClusterDefStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IClusterDefStatus.</returns>
        public static Sample.API.Models.IClusterDefStatus FromJson(Carbon.Json.JsonNode node)
        {
