namespace Sample.API.Models
{
    ...
    public partial class ClusterMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IClusterMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IClusterMetadata.</returns>
        public static Sample.API.Models.IClusterMetadata FromJson(Carbon.Json.JsonNode node)
        {
