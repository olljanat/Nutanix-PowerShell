namespace Sample.API.Models
{
    ...
    public partial class CloudCredentialsMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ICloudCredentialsMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ICloudCredentialsMetadata.</returns>
        public static Sample.API.Models.ICloudCredentialsMetadata FromJson(Carbon.Json.JsonNode node)
        {
