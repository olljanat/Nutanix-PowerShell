namespace Sample.API.Models
{
    ...
    public partial class MulticlusterConfigMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IMulticlusterConfigMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IMulticlusterConfigMetadata.</returns>
        public static Sample.API.Models.IMulticlusterConfigMetadata FromJson(Carbon.Json.JsonNode node)
        {
