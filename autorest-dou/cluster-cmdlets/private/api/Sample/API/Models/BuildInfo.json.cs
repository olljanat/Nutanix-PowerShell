namespace Sample.API.Models
{
    ...
    public partial class BuildInfo
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IBuildInfo.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IBuildInfo.</returns>
        public static Sample.API.Models.IBuildInfo FromJson(Carbon.Json.JsonNode node)
        {
