namespace Sample.API.Models
{
    ...
    public partial class ExternalConfigurationsSpec : Sample.API.Models.IExternalConfigurationsSpec, Microsoft.Rest.ClientRuntime.IValidates
    {
        /// <summary>Backing field for CitrixConnectorConfig property</summary>
        private Sample.API.Models.ICitrixConnectorConfigDetailsSpec _citrixConnectorConfig;

        /// <summary>Citrix Connector details.</summary>
        public Sample.API.Models.ICitrixConnectorConfigDetailsSpec CitrixConnectorConfig
        {
            get
            {
    ...
    public partial interface IExternalConfigurationsSpec : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        Sample.API.Models.ICitrixConnectorConfigDetailsSpec CitrixConnectorConfig { get; set; }
    }
}