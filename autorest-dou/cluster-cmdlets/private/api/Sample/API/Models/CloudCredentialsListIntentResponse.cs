namespace Sample.API.Models
{
    ...
    public partial class CloudCredentialsListIntentResponse : Sample.API.Models.ICloudCredentialsListIntentResponse, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        private Sample.API.Models.ICloudCredentialsIntentResource[] _entities;

        public Sample.API.Models.ICloudCredentialsIntentResource[] Entities
        {
            get
            {
        ...
        private Sample.API.Models.ICloudCredentialsListMetadataOutput _metadata;

        /// <summary>
        /// All api calls that return a list will have this metadata block
        /// </summary>
        public Sample.API.Models.ICloudCredentialsListMetadataOutput Metadata
        {
            get
            {
    ...
    public partial interface ICloudCredentialsListIntentResponse : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        ...
        Sample.API.Models.ICloudCredentialsIntentResource[] Entities { get; set; }
        Sample.API.Models.ICloudCredentialsListMetadataOutput Metadata { get; set; }
    }
}