namespace Sample.API.Models
{
    ...
    public partial class ClusterListMetadataOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IClusterListMetadataOutput.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IClusterListMetadataOutput.</returns>
        public static Sample.API.Models.IClusterListMetadataOutput FromJson(Carbon.Json.JsonNode node)
        {
