namespace Sample.API.Models
{
    ...
    public partial class ClusterManagementServer
    {
        ...
        internal ClusterManagementServer(Carbon.Json.JsonObject json)
        {
            ...
            _statusList = If( json?.PropertyT<Carbon.Json.JsonArray>("status_list"), out var __jsonStatusList) ? If( __jsonStatusList, out var __w) ? new System.Func<string[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __w, (__v)=> __v is Carbon.Json.JsonString __u ? (string)__u : null ) ) )() : null : StatusList;
            AfterFromJson(json);
        }
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IClusterManagementServer.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IClusterManagementServer.</returns>
        public static Sample.API.Models.IClusterManagementServer FromJson(Carbon.Json.JsonNode node)
        {
