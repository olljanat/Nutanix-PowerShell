namespace Sample.API.Models
{
    ...
    public partial class HypervisorServer
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IHypervisorServer.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IHypervisorServer.</returns>
        public static Sample.API.Models.IHypervisorServer FromJson(Carbon.Json.JsonNode node)
        {
