namespace Sample.API.Models
{
    ...
    public partial class ClusterIntentResponse
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IClusterIntentResponse.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IClusterIntentResponse.</returns>
        public static Sample.API.Models.IClusterIntentResponse FromJson(Carbon.Json.JsonNode node)
        {
