namespace Sample.API.Models
{
    ...
    public partial class ClusterListIntentResponse : Sample.API.Models.IClusterListIntentResponse, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        private Sample.API.Models.IClusterIntentResource[] _entities;

        public Sample.API.Models.IClusterIntentResource[] Entities
        {
            get
            {
        ...
        private Sample.API.Models.IClusterListMetadataOutput _metadata;

        /// <summary>
        /// All api calls that return a list will have this metadata block
        /// </summary>
        public Sample.API.Models.IClusterListMetadataOutput Metadata
        {
            get
            {
    ...
    public partial interface IClusterListIntentResponse : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        ...
        Sample.API.Models.IClusterIntentResource[] Entities { get; set; }
        Sample.API.Models.IClusterListMetadataOutput Metadata { get; set; }
    }
}