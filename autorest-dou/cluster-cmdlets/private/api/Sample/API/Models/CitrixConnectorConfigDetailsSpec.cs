namespace Sample.API.Models
{
    ...
    public partial class CitrixConnectorConfigDetailsSpec : Sample.API.Models.ICitrixConnectorConfigDetailsSpec, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        private Sample.API.Models.ICitrixResourceLocationSpec _resourceLocation;

        /// <summary>Resource Location on Citrix Cloud.</summary>
        public Sample.API.Models.ICitrixResourceLocationSpec ResourceLocation
        {
            get
            {
    ...
    public partial interface ICitrixConnectorConfigDetailsSpec : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        ...
        Sample.API.Models.ICitrixResourceLocationSpec ResourceLocation { get; set; }
    }
}