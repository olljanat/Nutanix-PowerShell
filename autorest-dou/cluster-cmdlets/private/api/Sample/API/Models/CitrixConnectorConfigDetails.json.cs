namespace Sample.API.Models
{
    ...
    public partial class CitrixConnectorConfigDetails
    {
        ...
        internal CitrixConnectorConfigDetails(Carbon.Json.JsonObject json)
        {
            ...
            _resourceLocation = If( json?.PropertyT<Carbon.Json.JsonObject>("resource_location"), out var __jsonResourceLocation) ? Sample.API.Models.CitrixResourceLocation.FromJson(__jsonResourceLocation) : ResourceLocation;
            AfterFromJson(json);
        }
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ICitrixConnectorConfigDetails.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ICitrixConnectorConfigDetails.</returns>
        public static Sample.API.Models.ICitrixConnectorConfigDetails FromJson(Carbon.Json.JsonNode node)
        {
