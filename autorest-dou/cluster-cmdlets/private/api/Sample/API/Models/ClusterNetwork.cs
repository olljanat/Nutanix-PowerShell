namespace Sample.API.Models
{
    ...
    public partial class ClusterNetwork : Sample.API.Models.IClusterNetwork, Microsoft.Rest.ClientRuntime.IValidates
    {
        /// <summary>Backing field for DomainServer property</summary>
        private Sample.API.Models.IClusterDomainServer _domainServer;

        /// <summary>
        /// Cluster domain server. Only applied to the cluster with all Hyper-V hosts.
        /// </summary>
        public Sample.API.Models.IClusterDomainServer DomainServer
        {
            get
            {
        ...
        /// <summary>Backing field for ExternalDataServicesIp property</summary>
        ...
        /// <summary>Backing field for ExternalIp property</summary>
        ...
        /// <summary>Backing field for ExternalSubnet property</summary>
        ...
        /// <summary>Backing field for HttpProxyList property</summary>
        private Sample.API.Models.IClusterNetworkEntity[] _httpProxyList;

        /// <summary>List of proxies to connect to the service centers.</summary>
        public Sample.API.Models.IClusterNetworkEntity[] HttpProxyList
        {
            get
            {
        ...
        /// <summary>Backing field for HttpProxyWhitelist property</summary>
        private Sample.API.Models.IHttpProxyWhitelist[] _httpProxyWhitelist;

        /// <summary>HTTP proxy whitelist.</summary>
        public Sample.API.Models.IHttpProxyWhitelist[] HttpProxyWhitelist
        {
            get
            {
        ...
        /// <summary>Backing field for InternalSubnet property</summary>
        ...
        /// <summary>Backing field for MasqueradingIp property</summary>
        ...
        /// <summary>Backing field for MasqueradingPort property</summary>
        ...
        /// <summary>Backing field for NameServerIpList property</summary>
        ...
        /// <summary>Backing field for NfsSubnetWhitelist property</summary>
        ...
        /// <summary>Backing field for NtpServerIpList property</summary>
        ...
        /// <summary>Backing field for SmtpServer property</summary>
        private Sample.API.Models.ISmtpServer _smtpServer;

        /// <summary>SMTP Server.</summary>
        public Sample.API.Models.ISmtpServer SmtpServer
        {
            get
            {
    ...
    public partial interface IClusterNetwork : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        Sample.API.Models.IClusterDomainServer DomainServer { get; set; }
        string ExternalDataServicesIp { get; set; }
        string ExternalIp { get; set; }
        string ExternalSubnet { get; set; }
        Sample.API.Models.IClusterNetworkEntity[] HttpProxyList { get; set; }
        Sample.API.Models.IHttpProxyWhitelist[] HttpProxyWhitelist { get; set; }
        ...
        Sample.API.Models.ISmtpServer SmtpServer { get; set; }
    }
}