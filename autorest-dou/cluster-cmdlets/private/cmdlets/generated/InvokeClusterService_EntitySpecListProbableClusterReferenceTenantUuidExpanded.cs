namespace Sample.API.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Invoke-ClusterService.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsLifecycle.Invoke, @"ClusterService_EntitySpecListProbableClusterReferenceTenantUuidExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IPlacementDetail))]
    public class InvokeClusterService_EntitySpecListProbableClusterReferenceTenantUuidExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public string ClusterReferenceKind
        {
            set
            {
                Spec.ProbableClusterReference = Spec.ProbableClusterReference ?? new Sample.API.Models.ClusterReference();
                Spec.ProbableClusterReference.Kind = value;
            }
        }
        ...
        public string ClusterReferenceName
        {
            ...
            {
                Spec.ProbableClusterReference = Spec.ProbableClusterReference ?? new Sample.API.Models.ClusterReference();
                Spec.ProbableClusterReference.Name = value;
            }
        }
        /// <summary>HELP MESSAGE MISSING</summary>
        ...
        public string ClusterReferenceUuid
        {
            ...
            {
                Spec.ProbableClusterReference = Spec.ProbableClusterReference ?? new Sample.API.Models.ClusterReference();
                Spec.ProbableClusterReference.Uuid = value;
            }
        }
        ...
        private Sample.API.Models.IPlacementSpec _spec= new Sample.API.Models.PlacementSpec();

        /// <summary>Entity placement spec</summary>
        public Sample.API.Models.IPlacementSpec Spec
        {
            get
            {
                return this._spec;
        ...
        /// <returns>
        /// a duplicate instance of InvokeClusterService_EntitySpecListProbableClusterReferenceTenantUuidExpanded
        /// </returns>
        public Sample.API.Cmdlets.InvokeClusterService_EntitySpecListProbableClusterReferenceTenantUuidExpanded Clone()
        {
        ...
        /// <returns>
        /// an instance of InvokeClusterService_EntitySpecListProbableClusterReferenceTenantUuidExpanded.
        /// </returns>
        public static Sample.API.Cmdlets.InvokeClusterService_EntitySpecListProbableClusterReferenceTenantUuidExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new InvokeClusterService_EntitySpecListProbableClusterReferenceTenantUuidExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="InvokeClusterService_EntitySpecListProbableClusterReferenceTenantUuidExpanded"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.InvokeClusterService_EntitySpecListProbableClusterReferenceTenantUuidExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeClusterService_EntitySpecListProbableClusterReferenceTenantUuidExpanded"
        /// /> cmdlet class.
        /// </summary>
        public InvokeClusterService_EntitySpecListProbableClusterReferenceTenantUuidExpanded()
        {
        }
        ...
        internal InvokeClusterService_EntitySpecListProbableClusterReferenceTenantUuidExpanded(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _spec = If( json?.PropertyT<Carbon.Json.JsonObject>("Spec"), out var __jsonSpec) ? Sample.API.Models.PlacementSpec.FromJson(__jsonSpec) : Spec;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'clusters' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.Clusters(Spec, onOK, onDefault, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="InvokeClusterService_EntitySpecListProbableClusterReferenceTenantUuidExpanded" />
        ...
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage)
        {
            using( NoSynchronizationContext )
            {
                // Error Response : default
                WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"The service encountered an unexpected result: {responseMessage.StatusCode}"), responseMessage.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { Spec}));
            }
        }
        /// <summary>a delegate that is called when the remote service returns 200 (OK).</summary>
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IPlacementDetail" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IPlacementDetail> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Sample.API.Models.IPlacementDetail
