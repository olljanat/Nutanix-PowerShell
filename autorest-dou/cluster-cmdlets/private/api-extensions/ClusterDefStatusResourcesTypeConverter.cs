namespace Sample.API.Models
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="ClusterDefStatusResources" />
    /// </summary>
    public class ClusterDefStatusResourcesTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        /// parameter.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="ClusterDefStatusResources"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="ClusterDefStatusResources" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="ClusterDefStatusResources" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        ...
        /// /> and <see cref="ignoreCase" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="ClusterDefStatusResources" />.</param>
        /// <returns>
        /// an instance of <see cref="ClusterDefStatusResources" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ClusterDefStatusResources.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new ClusterDefStatusResources
                {
                Analysis = ClusterAnalysisTypeConverter.ConvertFrom(sourceValue.Analysis),
                Config = ClusterConfigTypeConverter.ConvertFrom(sourceValue.Config),
                Network = ClusterNetworkTypeConverter.ConvertFrom(sourceValue.Network),
                Nodes = ClusterNodesTypeConverter.ConvertFrom(sourceValue.Nodes),
