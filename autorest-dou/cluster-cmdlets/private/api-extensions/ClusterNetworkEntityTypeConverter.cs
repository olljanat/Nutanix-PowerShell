namespace Sample.API.Models
{
    ...
    /// </summary>
    public class ClusterNetworkEntityTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ClusterNetworkEntity.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new ClusterNetworkEntity
                {
                Address = AddressTypeConverter.ConvertFrom(sourceValue.Address),
                Credentials = CredentialsTypeConverter.ConvertFrom(sourceValue.Credentials),
                ProxyTypeList = sourceValue.ProxyTypeList,
                };
            }
            catch
            {
