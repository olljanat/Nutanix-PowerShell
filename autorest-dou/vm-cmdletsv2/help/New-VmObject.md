...
```
New-VmObject -AvailabilityZoneReferenceKind <String> [-AvailabilityZoneReferenceName <String>]
 -AvailabilityZoneReferenceUuid <String> -ClusterReferenceKind <String> [-ClusterReferenceName <String>]
 -ClusterReferenceUuid <String> [-Description <String>] -Name <String> -Resources <IVmResources>
 [<CommonParameters>]
```
