...
```
Get-ServiceSnapshost -GetEntitiesRequest <IVmSnapshotListMetadata> [-HttpPipelineAppend <SendAsyncStep[]>]
...
```
Get-ServiceSnapshost [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>]
...
```yaml
Type: System.String
Parameter Sets: SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded
Aliases:
...
```yaml
Type: Sample.API.Models.IVmSnapshotListMetadata
Parameter Sets: SnapshostsFilterKindLengthOffsetSortAttributeSortOrder
Aliases:
