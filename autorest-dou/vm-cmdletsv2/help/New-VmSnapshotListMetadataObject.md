...
# New-VmSnapshotListMetadataObject
...
```
New-VmSnapshotListMetadataObject [-Filter <String>] [-Kind <String>] [-Length <Int32>] [-Offset <Int32>]
 [-SortAttribute <String>] [-SortOrder <String>] [<CommonParameters>]
```
