function New-VmRecoveryPointListMetadataObject {
[CmdletBinding()]
param(
...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('NutanixIntentfulAPI.private\New-VmRecoveryPointListMetadataObject', [System.Management.Automation.CommandTypes]::Cmdlet)
...
.ForwardHelpTargetName NutanixIntentfulAPI.private\New-VmRecoveryPointListMetadataObject
