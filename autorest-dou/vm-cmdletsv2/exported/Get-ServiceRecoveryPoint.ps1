...
')]
    ...
    [Parameter(ParameterSetName='RecoveryPointUuid', HelpMessage='The username for authentication')]
    [string]
    ${username},

    [Parameter(ParameterSetName='RecoveryPointUuid', HelpMessage='The password for authentication')]
    [string]
    ${password},

    [Parameter(ParameterSetName='RecoveryPointUuid', HelpMessage='Skip the ssl validation')]
    [switch]
    ${SkipSSL},
