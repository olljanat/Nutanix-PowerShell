namespace Sample.API.Models
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="VmSnapshotDefStatusReplicationTargetListItemType"
    /// />
    /// </summary>
    public class VmSnapshotDefStatusReplicationTargetListItemTypeTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        /// parameter.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="VmSnapshotDefStatusReplicationTargetListItemType"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="VmSnapshotDefStatusReplicationTargetListItemType" /> type,
        /// otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="VmSnapshotDefStatusReplicationTargetListItemType" />, or <c>null</c> if there is no suitable
        /// conversion.
        /// </returns>
        ...
        /// /> and <see cref="ignoreCase" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="VmSnapshotDefStatusReplicationTargetListItemType"
        /// />.</param>
        /// <returns>
        /// an instance of <see cref="VmSnapshotDefStatusReplicationTargetListItemType" />, or <c>null</c> if there is no suitable
        /// conversion.
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                VmSnapshotDefStatusReplicationTargetListItemType.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new VmSnapshotDefStatusReplicationTargetListItemType
                {
