namespace Sample.API.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Get-ServiceSnapshot.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"ServiceSnapshot_SnapshotUuid")]
    ...
    public class GetServiceSnapshot_SnapshotUuid : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetServiceSnapshot_SnapshotUuid</returns>
        public Sample.API.Cmdlets.GetServiceSnapshot_SnapshotUuid Clone()
        {
        ...
        /// <returns>an instance of GetServiceSnapshot_SnapshotUuid.</returns>
        public static Sample.API.Cmdlets.GetServiceSnapshot_SnapshotUuid FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetServiceSnapshot_SnapshotUuid(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetServiceSnapshot_SnapshotUuid" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetServiceSnapshot_SnapshotUuid FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetServiceSnapshot_SnapshotUuid" /> cmdlet class.
        /// </summary>
        public GetServiceSnapshot_SnapshotUuid()
        {
        }
        ...
        internal GetServiceSnapshot_SnapshotUuid(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.GetSnapshot(Uuid, onOK, onNotFound, onDefault, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetServiceSnapshot_SnapshotUuid" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
        ...
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IVmSnapshotIntentResponse> response)
        {
            using( NoSynchronizationContext )
            {
