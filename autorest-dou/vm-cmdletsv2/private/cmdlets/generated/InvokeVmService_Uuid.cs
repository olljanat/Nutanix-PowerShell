namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsLifecycle.Invoke, @"VmService_Uuid", SupportsShouldProcess = true)]
    ...
    public class InvokeVmService_Uuid : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of InvokeVmService_Uuid</returns>
        public Sample.API.Cmdlets.InvokeVmService_Uuid Clone()
        {
        ...
        /// <returns>an instance of InvokeVmService_Uuid.</returns>
        public static Sample.API.Cmdlets.InvokeVmService_Uuid FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new InvokeVmService_Uuid(json) : null;
        }
        /// <summary>
        ...
        /// <returns>returns a new instance of the <see cref="InvokeVmService_Uuid" /> cmdlet</returns>
        public static Sample.API.Cmdlets.InvokeVmService_Uuid FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeVmService_Uuid" /> cmdlet class.
        /// </summary>
        public InvokeVmService_Uuid()
        {
        }
        ...
        internal InvokeVmService_Uuid(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.Vms(Uuid, onAccepted, onNotFound, onDefault, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="InvokeVmService_Uuid" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
