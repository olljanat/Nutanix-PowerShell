namespace Sample.API.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Get-ServiceRecoveryPoint.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"ServiceRecoveryPoint_RecoveryPointsFilterKindLengthOffsetSortAttributeSortOrderExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IVmRecoveryPointListIntentResponse))]
    public class GetServiceRecoveryPoint_RecoveryPointsFilterKindLengthOffsetSortAttributeSortOrderExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.IVmRecoveryPointListMetadata _getEntitiesRequest= new Sample.API.Models.VmRecoveryPointListMetadata();

        /// <summary>
        /// All api calls that return a list will have this metadata block as input
        /// </summary>
        public Sample.API.Models.IVmRecoveryPointListMetadata GetEntitiesRequest
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of GetServiceRecoveryPoint_RecoveryPointsFilterKindLengthOffsetSortAttributeSortOrderExpanded
        /// </returns>
        public Sample.API.Cmdlets.GetServiceRecoveryPoint_RecoveryPointsFilterKindLengthOffsetSortAttributeSortOrderExpanded Clone()
        {
        ...
        /// <returns>
        /// an instance of GetServiceRecoveryPoint_RecoveryPointsFilterKindLengthOffsetSortAttributeSortOrderExpanded.
        /// </returns>
        public static Sample.API.Cmdlets.GetServiceRecoveryPoint_RecoveryPointsFilterKindLengthOffsetSortAttributeSortOrderExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetServiceRecoveryPoint_RecoveryPointsFilterKindLengthOffsetSortAttributeSortOrderExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetServiceRecoveryPoint_RecoveryPointsFilterKindLengthOffsetSortAttributeSortOrderExpanded"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetServiceRecoveryPoint_RecoveryPointsFilterKindLengthOffsetSortAttributeSortOrderExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetServiceRecoveryPoint_RecoveryPointsFilterKindLengthOffsetSortAttributeSortOrderExpanded"
        /// /> cmdlet class.
        /// </summary>
        public GetServiceRecoveryPoint_RecoveryPointsFilterKindLengthOffsetSortAttributeSortOrderExpanded()
        {
        }
        ...
        internal GetServiceRecoveryPoint_RecoveryPointsFilterKindLengthOffsetSortAttributeSortOrderExpanded(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _getEntitiesRequest = If( json?.PropertyT<Carbon.Json.JsonObject>("GetEntitiesRequest"), out var __jsonGetEntitiesRequest) ? Sample.API.Models.VmRecoveryPointListMetadata.FromJson(__jsonGetEntitiesRequest) : GetEntitiesRequest;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GetRecoveryPoints' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.GetRecoveryPoints(GetEntitiesRequest, onOK, onDefault, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetServiceRecoveryPoint_RecoveryPointsFilterKindLengthOffsetSortAttributeSortOrderExpanded"
        ...
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IVmRecoveryPointListIntentResponse" /> from the
        /// remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IVmRecoveryPointListIntentResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Sample.API.Models.IVmRecoveryPointListIntentResponse
