namespace Sample.API.Cmdlets
{
    ...
    public class GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// </returns>
        public Sample.API.Cmdlets.GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder FromJson(Carbon.Json.JsonNode node)
        {
        ...
        /// </returns>
        public static Sample.API.Cmdlets.GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.GetVms(GetEntitiesRequest, onOK, onDefault, this, Pipeline, this.username.ToString(), this.password);
