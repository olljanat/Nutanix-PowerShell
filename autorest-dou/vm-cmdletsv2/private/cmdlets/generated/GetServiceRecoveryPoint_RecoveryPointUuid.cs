namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"ServiceRecoveryPoint_RecoveryPointUuid")]
    ...
    public class GetServiceRecoveryPoint_RecoveryPointUuid : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetServiceRecoveryPoint_RecoveryPointUuid</returns>
        public Sample.API.Cmdlets.GetServiceRecoveryPoint_RecoveryPointUuid Clone()
        {
        ...
        /// <returns>an instance of GetServiceRecoveryPoint_RecoveryPointUuid.</returns>
        public static Sample.API.Cmdlets.GetServiceRecoveryPoint_RecoveryPointUuid FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetServiceRecoveryPoint_RecoveryPointUuid(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetServiceRecoveryPoint_RecoveryPointUuid" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetServiceRecoveryPoint_RecoveryPointUuid FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetServiceRecoveryPoint_RecoveryPointUuid" /> cmdlet class.
        /// </summary>
        public GetServiceRecoveryPoint_RecoveryPointUuid()
        {
        }
        ...
        internal GetServiceRecoveryPoint_RecoveryPointUuid(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.GetRecoveryPoint(Uuid, onOK, onNotFound, onDefault, this, Pipeline,this.username, this.password);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetServiceRecoveryPoint_RecoveryPointUuid" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
