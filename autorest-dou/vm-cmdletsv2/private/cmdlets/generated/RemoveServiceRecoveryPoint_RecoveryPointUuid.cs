namespace Sample.API.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Remove-ServiceRecoveryPoint.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"ServiceRecoveryPoint_RecoveryPointUuid", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IVmRecoveryPointStatus))]
    public class RemoveServiceRecoveryPoint_RecoveryPointUuid : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveServiceRecoveryPoint_RecoveryPointUuid</returns>
        public Sample.API.Cmdlets.RemoveServiceRecoveryPoint_RecoveryPointUuid Clone()
        {
        ...
        /// <returns>an instance of RemoveServiceRecoveryPoint_RecoveryPointUuid.</returns>
        public static Sample.API.Cmdlets.RemoveServiceRecoveryPoint_RecoveryPointUuid FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveServiceRecoveryPoint_RecoveryPointUuid(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="RemoveServiceRecoveryPoint_RecoveryPointUuid" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.RemoveServiceRecoveryPoint_RecoveryPointUuid FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteRecoveryPoint' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.DeleteRecoveryPoint(Uuid, onOK, onNotFound, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveServiceRecoveryPoint_RecoveryPointUuid" /> cmdlet class.
        /// </summary>
        public RemoveServiceRecoveryPoint_RecoveryPointUuid()
        {
        }
        ...
        internal RemoveServiceRecoveryPoint_RecoveryPointUuid(Carbon.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="RemoveServiceRecoveryPoint_RecoveryPointUuid" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
