namespace Sample.API.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Get-ServiceSnapshost.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"ServiceSnapshost_SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IVmSnapshotListIntentResponse))]
    public class GetServiceSnapshost_SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.IVmSnapshotListMetadata _getEntitiesRequest= new Sample.API.Models.VmSnapshotListMetadata();

        /// <summary>
        /// All api calls that return a list will have this metadata block as input
        /// </summary>
        public Sample.API.Models.IVmSnapshotListMetadata GetEntitiesRequest
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of GetServiceSnapshost_SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded
        /// </returns>
        public Sample.API.Cmdlets.GetServiceSnapshost_SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded Clone()
        {
        ...
        /// <returns>
        /// an instance of GetServiceSnapshost_SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded.
        /// </returns>
        public static Sample.API.Cmdlets.GetServiceSnapshost_SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetServiceSnapshost_SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetServiceSnapshost_SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetServiceSnapshost_SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetServiceSnapshost_SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded"
        /// /> cmdlet class.
        /// </summary>
        public GetServiceSnapshost_SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded()
        {
        }
        ...
        internal GetServiceSnapshost_SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _getEntitiesRequest = If( json?.PropertyT<Carbon.Json.JsonObject>("GetEntitiesRequest"), out var __jsonGetEntitiesRequest) ? Sample.API.Models.VmSnapshotListMetadata.FromJson(__jsonGetEntitiesRequest) : GetEntitiesRequest;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'GetSnapshosts' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.GetSnapshosts(GetEntitiesRequest, onOK, onDefault, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetServiceSnapshost_SnapshostsFilterKindLengthOffsetSortAttributeSortOrderExpanded"
        ...
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IVmSnapshotListIntentResponse" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IVmSnapshotListIntentResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Sample.API.Models.IVmSnapshotListIntentResponse
