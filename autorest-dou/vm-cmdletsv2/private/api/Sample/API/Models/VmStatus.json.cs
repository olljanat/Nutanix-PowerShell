namespace Sample.API.Models
{
    ...
    public partial class VmStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IVmStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IVmStatus.</returns>
        public static Sample.API.Models.IVmStatus FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new VmStatus(json) : null;
        }
        /// <summary>
        ...
        internal VmStatus(Carbon.Json.JsonObject json)
        {
            bool returnNow = false;
