namespace Sample.API.Models
{
    ...
    public partial class NetworkSecurityRuleResourcesIsolationRule
    {
        ...
        public static Sample.API.Models.INetworkSecurityRuleResourcesIsolationRule FromJsonString(string jsonText) => FromJson(Carbon.Json.JsonNode.Parse(jsonText));
