namespace Sample.API.Models
{
    ...
    public partial class NetworkSecurityRuleStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.INetworkSecurityRuleStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.INetworkSecurityRuleStatus.</returns>
        public static Sample.API.Models.INetworkSecurityRuleStatus FromJson(Carbon.Json.JsonNode node)
        {
