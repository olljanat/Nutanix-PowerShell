namespace Sample.API.Models
{
    ...
    public partial class NetworkSecurityRuleListMetadataOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.INetworkSecurityRuleListMetadataOutput.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.INetworkSecurityRuleListMetadataOutput.</returns>
        public static Sample.API.Models.INetworkSecurityRuleListMetadataOutput FromJson(Carbon.Json.JsonNode node)
        {
