namespace Sample.API.Models
{
    ...
    public partial class NetworkSecurityRuleListMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.INetworkSecurityRuleListMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.INetworkSecurityRuleListMetadata.</returns>
        public static Sample.API.Models.INetworkSecurityRuleListMetadata FromJson(Carbon.Json.JsonNode node)
        {
