namespace Sample.API.Models
{
    ...
    public partial class NetworkSecurityRuleDefStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.INetworkSecurityRuleDefStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.INetworkSecurityRuleDefStatus.</returns>
        public static Sample.API.Models.INetworkSecurityRuleDefStatus FromJson(Carbon.Json.JsonNode node)
        {
        ...
        internal NetworkSecurityRuleDefStatus(Carbon.Json.JsonObject json)
        {
            ...
            _resources = If( json?.PropertyT<Carbon.Json.JsonObject>("resources"), out var __jsonResources) ? Sample.API.Models.NetworkSecurityRuleResources.FromJson(__jsonResources) : Resources;
