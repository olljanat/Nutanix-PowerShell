namespace Sample.API.Models
{
    ...
    public partial class NetworkSecurityRuleResourcesAppRule
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.INetworkSecurityRuleResourcesAppRule.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.INetworkSecurityRuleResourcesAppRule.</returns>
        public static Sample.API.Models.INetworkSecurityRuleResourcesAppRule FromJson(Carbon.Json.JsonNode node)
        {
