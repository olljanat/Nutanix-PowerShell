namespace Sample.API.Models
{
    ...
    public partial class NetworkRuleIcmpTypeCodeListItemType
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.INetworkRuleIcmpTypeCodeListItemType.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.INetworkRuleIcmpTypeCodeListItemType.</returns>
        public static Sample.API.Models.INetworkRuleIcmpTypeCodeListItemType FromJson(Carbon.Json.JsonNode node)
        {
