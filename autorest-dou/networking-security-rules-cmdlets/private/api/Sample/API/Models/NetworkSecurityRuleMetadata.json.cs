namespace Sample.API.Models
{
    ...
    public partial class NetworkSecurityRuleMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.INetworkSecurityRuleMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.INetworkSecurityRuleMetadata.</returns>
        public static Sample.API.Models.INetworkSecurityRuleMetadata FromJson(Carbon.Json.JsonNode node)
        {
