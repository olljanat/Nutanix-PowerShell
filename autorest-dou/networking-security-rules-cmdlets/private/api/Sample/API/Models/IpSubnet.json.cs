namespace Sample.API.Models
{
    ...
    public partial class IpSubnet
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IIpSubnet.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IIpSubnet.</returns>
        public static Sample.API.Models.IIpSubnet FromJson(Carbon.Json.JsonNode node)
        {
