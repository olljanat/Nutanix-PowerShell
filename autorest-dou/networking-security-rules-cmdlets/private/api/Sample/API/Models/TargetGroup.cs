namespace Sample.API.Models
{
    ...
    public partial class TargetGroup : Sample.API.Models.ITargetGroup, Microsoft.Rest.ClientRuntime.IValidates
    {
        /// <summary>Backing field for DefaultInternalPolicy property</summary>
