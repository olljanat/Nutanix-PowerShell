namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsLifecycle.Invoke, @"SecurityNetwork_ApiVersionMetadataSpecExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.INetworkSecurityRuleIntentResponse))]
    public class InvokeSecurityNetwork_ApiVersionMetadataSpecExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.INetworkSecurityRuleIntentInput _body= new Sample.API.Models.NetworkSecurityRuleIntentInput();

        /// <summary>An intentful representation of a network_security_rule</summary>
        public Sample.API.Models.INetworkSecurityRuleIntentInput Body
        {
            get
            {
                return this._body;
        ...
        public string[] CategoryFilterKindList
        {
            set
            {
                Body.Spec = Body.Spec ?? new Sample.API.Models.NetworkSecurityRule();
                Body.Spec.Resources = Body.Spec.Resources ?? new Sample.API.Models.NetworkSecurityRuleResources();
                Body.Spec.Resources.AppRule = Body.Spec.Resources.AppRule ?? new Sample.API.Models.NetworkSecurityRuleResourcesAppRule();
                Body.Spec.Resources.AppRule.TargetGroup = Body.Spec.Resources.AppRule.TargetGroup ?? new Sample.API.Models.TargetGroup();
                Body.Spec.Resources.AppRule.TargetGroup.Filter = Body.Spec.Resources.AppRule.TargetGroup.Filter ?? new Sample.API.Models.CategoryFilter();
        ...
        public string[] CategoryFilterKindList1
        {
            set
            {
                Body.Spec = Body.Spec ?? new Sample.API.Models.NetworkSecurityRule();
                Body.Spec.Resources = Body.Spec.Resources ?? new Sample.API.Models.NetworkSecurityRuleResources();
                Body.Spec.Resources.IsolationRule = Body.Spec.Resources.IsolationRule ?? new Sample.API.Models.NetworkSecurityRuleResourcesIsolationRule();
                Body.Spec.Resources.IsolationRule.FirstEntityFilter = Body.Spec.Resources.IsolationRule.FirstEntityFilter ?? new Sample.API.Models.CategoryFilter();
        ...
        public string[] CategoryFilterKindList2
        {
            set
            {
                ...
                Body.Spec.Resources = Body.Spec.Resources ?? new Sample.API.Models.NetworkSecurityRuleResources();
                Body.Spec.Resources.IsolationRule = Body.Spec.Resources.IsolationRule ?? new Sample.API.Models.NetworkSecurityRuleResourcesIsolationRule();
                Body.Spec.Resources.IsolationRule.SecondEntityFilter = Body.Spec.Resources.IsolationRule.SecondEntityFilter ?? new Sample.API.Models.CategoryFilter();
        ...
        public string[] CategoryFilterKindList3
        {
            set
            {
                Body.Spec = Body.Spec ?? new Sample.API.Models.NetworkSecurityRule();
                Body.Spec.Resources = Body.Spec.Resources ?? new Sample.API.Models.NetworkSecurityRuleResources();
                Body.Spec.Resources.QuarantineRule = Body.Spec.Resources.QuarantineRule ?? new Sample.API.Models.NetworkSecurityRuleResourcesQuarantineRule();
                Body.Spec.Resources.QuarantineRule.TargetGroup = Body.Spec.Resources.QuarantineRule.TargetGroup ?? new Sample.API.Models.TargetGroup();
                Body.Spec.Resources.QuarantineRule.TargetGroup.Filter = Body.Spec.Resources.QuarantineRule.TargetGroup.Filter ?? new Sample.API.Models.CategoryFilter();
        ...
        /// <returns>a duplicate instance of InvokeSecurityNetwork_ApiVersionMetadataSpecExpanded</returns>
        public Sample.API.Cmdlets.InvokeSecurityNetwork_ApiVersionMetadataSpecExpanded Clone()
        {
        ...
        /// <returns>an instance of InvokeSecurityNetwork_ApiVersionMetadataSpecExpanded.</returns>
        public static Sample.API.Cmdlets.InvokeSecurityNetwork_ApiVersionMetadataSpecExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new InvokeSecurityNetwork_ApiVersionMetadataSpecExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="InvokeSecurityNetwork_ApiVersionMetadataSpecExpanded" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.InvokeSecurityNetwork_ApiVersionMetadataSpecExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeSecurityNetwork_ApiVersionMetadataSpecExpanded" /> cmdlet class.
        /// </summary>
        public InvokeSecurityNetwork_ApiVersionMetadataSpecExpanded()
        {
        }
        ...
        internal InvokeSecurityNetwork_ApiVersionMetadataSpecExpanded(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _body = If( json?.PropertyT<Carbon.Json.JsonObject>("Body"), out var __jsonBody) ? Sample.API.Models.NetworkSecurityRuleIntentInput.FromJson(__jsonBody) : Body;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'network_security_rules' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.NetworkSecurityRules(Body, onAccepted, onDefault, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="InvokeSecurityNetwork_ApiVersionMetadataSpecExpanded" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.INetworkSecurityRuleIntentResponse" /> from the
        /// remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onAccepted(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.INetworkSecurityRuleIntentResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onAccepted - response for 202 / application/json
                // (await response) // should be Sample.API.Models.INetworkSecurityRuleIntentResponse
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.INetworkSecurityRuleStatus" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.INetworkSecurityRuleStatus> response)
        {
            using( NoSynchronizationContext )
            {
