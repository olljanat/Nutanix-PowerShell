namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsLifecycle.Invoke, @"SecurityNetwork_ApiVersionMetadataSpec", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.INetworkSecurityRuleIntentResponse))]
    public class InvokeSecurityNetwork_ApiVersionMetadataSpec : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.INetworkSecurityRuleIntentInput _body;
        ...
        /// <returns>a duplicate instance of InvokeSecurityNetwork_ApiVersionMetadataSpec</returns>
        public Sample.API.Cmdlets.InvokeSecurityNetwork_ApiVersionMetadataSpec Clone()
        {
        ...
        /// <returns>an instance of InvokeSecurityNetwork_ApiVersionMetadataSpec.</returns>
        public static Sample.API.Cmdlets.InvokeSecurityNetwork_ApiVersionMetadataSpec FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new InvokeSecurityNetwork_ApiVersionMetadataSpec(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="InvokeSecurityNetwork_ApiVersionMetadataSpec" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.InvokeSecurityNetwork_ApiVersionMetadataSpec FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeSecurityNetwork_ApiVersionMetadataSpec" /> cmdlet class.
        /// </summary>
        public InvokeSecurityNetwork_ApiVersionMetadataSpec()
        {
        }
        ...
        internal InvokeSecurityNetwork_ApiVersionMetadataSpec(Carbon.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="InvokeSecurityNetwork_ApiVersionMetadataSpec" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
