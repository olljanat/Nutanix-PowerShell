namespace Sample.API.ModelCmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.ICategoryFilter))]
    public class NewCategoryFilterObject : System.Management.Automation.PSCmdlet
    {
        ...
        private Sample.API.Models.ICategoryFilter _categoryFilter = new Sample.API.Models.CategoryFilter();
