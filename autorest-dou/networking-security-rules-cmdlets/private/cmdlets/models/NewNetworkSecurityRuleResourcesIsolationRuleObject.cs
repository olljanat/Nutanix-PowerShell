namespace Sample.API.ModelCmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.INetworkSecurityRuleResourcesIsolationRule))]
    public class NewNetworkSecurityRuleResourcesIsolationRuleObject : System.Management.Automation.PSCmdlet
    {
        ...
        private Sample.API.Models.INetworkSecurityRuleResourcesIsolationRule _networkSecurityRuleResourcesIsolationRule = new Sample.API.Models.NetworkSecurityRuleResourcesIsolationRule();
        ...
        public string[] CategoryFilterKindList
        {
            set
            {
                _networkSecurityRuleResourcesIsolationRule.FirstEntityFilter = _networkSecurityRuleResourcesIsolationRule.FirstEntityFilter ?? new Sample.API.Models.CategoryFilter();
        ...
        public string[] CategoryFilterKindList1
        {
            set
            {
                _networkSecurityRuleResourcesIsolationRule.SecondEntityFilter = _networkSecurityRuleResourcesIsolationRule.SecondEntityFilter ?? new Sample.API.Models.CategoryFilter();
