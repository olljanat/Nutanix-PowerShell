namespace Sample.API.ModelCmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.INetworkSecurityRuleResources))]
    public class NewNetworkSecurityRuleResourcesObject : System.Management.Automation.PSCmdlet
    {
        ...
        private Sample.API.Models.INetworkSecurityRuleResources _networkSecurityRuleResources = new Sample.API.Models.NetworkSecurityRuleResources();
        ...
        public string[] CategoryFilterKindList
        {
            set
            {
                _networkSecurityRuleResources.AppRule = _networkSecurityRuleResources.AppRule ?? new Sample.API.Models.NetworkSecurityRuleResourcesAppRule();
                _networkSecurityRuleResources.AppRule.TargetGroup = _networkSecurityRuleResources.AppRule.TargetGroup ?? new Sample.API.Models.TargetGroup();
                _networkSecurityRuleResources.AppRule.TargetGroup.Filter = _networkSecurityRuleResources.AppRule.TargetGroup.Filter ?? new Sample.API.Models.CategoryFilter();
        ...
        public string[] CategoryFilterKindList1
        {
            set
            {
                _networkSecurityRuleResources.IsolationRule = _networkSecurityRuleResources.IsolationRule ?? new Sample.API.Models.NetworkSecurityRuleResourcesIsolationRule();
                _networkSecurityRuleResources.IsolationRule.FirstEntityFilter = _networkSecurityRuleResources.IsolationRule.FirstEntityFilter ?? new Sample.API.Models.CategoryFilter();
        ...
        public string[] CategoryFilterKindList2
        {
            ...
            {
                _networkSecurityRuleResources.IsolationRule = _networkSecurityRuleResources.IsolationRule ?? new Sample.API.Models.NetworkSecurityRuleResourcesIsolationRule();
                _networkSecurityRuleResources.IsolationRule.SecondEntityFilter = _networkSecurityRuleResources.IsolationRule.SecondEntityFilter ?? new Sample.API.Models.CategoryFilter();
        ...
        public string[] CategoryFilterKindList3
        {
            set
            {
                _networkSecurityRuleResources.QuarantineRule = _networkSecurityRuleResources.QuarantineRule ?? new Sample.API.Models.NetworkSecurityRuleResourcesQuarantineRule();
                _networkSecurityRuleResources.QuarantineRule.TargetGroup = _networkSecurityRuleResources.QuarantineRule.TargetGroup ?? new Sample.API.Models.TargetGroup();
                _networkSecurityRuleResources.QuarantineRule.TargetGroup.Filter = _networkSecurityRuleResources.QuarantineRule.TargetGroup.Filter ?? new Sample.API.Models.CategoryFilter();
