namespace Sample.API.ModelCmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.INetworkSecurityRuleResourcesAppRule))]
    public class NewNetworkSecurityRuleResourcesAppRuleObject : System.Management.Automation.PSCmdlet
    {
        ...
        private Sample.API.Models.INetworkSecurityRuleResourcesAppRule _networkSecurityRuleResourcesAppRule = new Sample.API.Models.NetworkSecurityRuleResourcesAppRule();
        ...
        public string[] CategoryFilterKindList
        {
            set
            {
                _networkSecurityRuleResourcesAppRule.TargetGroup = _networkSecurityRuleResourcesAppRule.TargetGroup ?? new Sample.API.Models.TargetGroup();
                _networkSecurityRuleResourcesAppRule.TargetGroup.Filter = _networkSecurityRuleResourcesAppRule.TargetGroup.Filter ?? new Sample.API.Models.CategoryFilter();
