function New-NetworkSecurityRuleIntentInputObject {
[CmdletBinding()]
param(
    ...
    [Parameter(ParameterSetName='default', Mandatory=$true, HelpMessage='The network_security_rule kind metadata')]
...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('NutanixIntentfulAPI.private\New-NetworkSecurityRuleIntentInputObject', [System.Management.Automation.CommandTypes]::Cmdlet)
...
.ForwardHelpTargetName NutanixIntentfulAPI.private\New-NetworkSecurityRuleIntentInputObject
