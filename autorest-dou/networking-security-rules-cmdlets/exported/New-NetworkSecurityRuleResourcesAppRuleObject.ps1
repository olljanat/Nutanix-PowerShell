function New-NetworkSecurityRuleResourcesAppRuleObject {
[CmdletBinding()]
param(
...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('NutanixIntentfulAPI.private\New-NetworkSecurityRuleResourcesAppRuleObject', [System.Management.Automation.CommandTypes]::Cmdlet)
...
.ForwardHelpTargetName NutanixIntentfulAPI.private\New-NetworkSecurityRuleResourcesAppRuleObject
