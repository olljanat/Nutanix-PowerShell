namespace Sample.API.Models
{
    ...
    public partial class CategoryListMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ICategoryListMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ICategoryListMetadata.</returns>
        public static Sample.API.Models.ICategoryListMetadata FromJson(Carbon.Json.JsonNode node)
        {
