namespace Sample.API.Models
{
    ...
    public partial class CategoryQueryResponseResultsItemType : Sample.API.Models.ICategoryQueryResponseResultsItemType, Microsoft.Rest.ClientRuntime.IValidates
    {
        /// <summary>Backing field for EntityAnyReferenceList property</summary>
        private Sample.API.Models.IEntityReference[] _entityAnyReferenceList;

        /// <summary>List of entity references.</summary>
        public Sample.API.Models.IEntityReference[] EntityAnyReferenceList
        {
            get
            {
        ...
        /// <summary>Backing field for FilteredEntityCount property</summary>
        ...
        /// <summary>Backing field for TotalEntityCount property</summary>
    ...
    public partial interface ICategoryQueryResponseResultsItemType : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        Sample.API.Models.IEntityReference[] EntityAnyReferenceList { get; set; }
