namespace Sample.API.Models
{
    ...
    public partial class CategoryQueryResponseResultsItemType
    {
        ...
        internal CategoryQueryResponseResultsItemType(Carbon.Json.JsonObject json)
        {
            ...
            _entityAnyReferenceList = If( json?.PropertyT<Carbon.Json.JsonArray>("entity_any_reference_list"), out var __jsonEntityAnyReferenceList) ? If( __jsonEntityAnyReferenceList, out var __w) ? new System.Func<Sample.API.Models.IEntityReference[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __w, (__v)=> Sample.API.Models.EntityReference.FromJson(__v)  ) ) )() : null : EntityAnyReferenceList;
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ICategoryQueryResponseResultsItemType.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ICategoryQueryResponseResultsItemType.</returns>
        public static Sample.API.Models.ICategoryQueryResponseResultsItemType FromJson(Carbon.Json.JsonNode node)
        {
        ...
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.SerializationMode serializationMode)
        {
            ...
            if (null != EntityAnyReferenceList)
            {
                ...
                foreach( var __y in EntityAnyReferenceList )
                {
                    AddIf(__y?.ToJson(null) ,__x.Add);
                }
                container.Add("entity_any_reference_list",__x);
            }
