namespace Sample.API.Models
{
    ...
    public partial class CategoryStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ICategoryStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ICategoryStatus.</returns>
        public static Sample.API.Models.ICategoryStatus FromJson(Carbon.Json.JsonNode node)
        {
