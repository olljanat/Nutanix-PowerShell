namespace Sample.API.Models
{
    ...
    public partial class CategoryQueryInput
    {
        ...
        internal CategoryQueryInput(Carbon.Json.JsonObject json)
        {
            ...
            _categoryFilter = If( json?.PropertyT<Carbon.Json.JsonObject>("category_filter"), out var __jsonCategoryFilter) ? Sample.API.Models.CategoryFilter.FromJson(__jsonCategoryFilter) : CategoryFilter;
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ICategoryQueryInput.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ICategoryQueryInput.</returns>
        public static Sample.API.Models.ICategoryQueryInput FromJson(Carbon.Json.JsonNode node)
        {
