namespace Sample.API.Models
{
    ...
    public partial class EntityReference
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IEntityReference.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IEntityReference.</returns>
        public static Sample.API.Models.IEntityReference FromJson(Carbon.Json.JsonNode node)
        {
