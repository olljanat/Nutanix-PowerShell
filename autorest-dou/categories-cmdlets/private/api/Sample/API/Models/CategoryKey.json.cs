namespace Sample.API.Models
{
    ...
    public partial class CategoryKey
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ICategoryKey.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ICategoryKey.</returns>
        public static Sample.API.Models.ICategoryKey FromJson(Carbon.Json.JsonNode node)
        {
