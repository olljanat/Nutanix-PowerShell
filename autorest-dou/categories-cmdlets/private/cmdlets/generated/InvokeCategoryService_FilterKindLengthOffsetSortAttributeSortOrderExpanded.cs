namespace Sample.API.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Invoke-CategoryService.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsLifecycle.Invoke, @"CategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.ICategoryKeyListResponse))]
    public class InvokeCategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.ICategoryListMetadata _getEntitiesRequest= new Sample.API.Models.CategoryListMetadata();

        /// <summary>
        /// All api calls that return a list will have this metadata block as input
        /// </summary>
        public Sample.API.Models.ICategoryListMetadata GetEntitiesRequest
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of InvokeCategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded
        /// </returns>
        public Sample.API.Cmdlets.InvokeCategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded Clone()
        {
        ...
        /// <returns>
        /// an instance of InvokeCategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded.
        /// </returns>
        public static Sample.API.Cmdlets.InvokeCategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new InvokeCategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="InvokeCategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded" />
        /// cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.InvokeCategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeCategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded"
        /// /> cmdlet class.
        /// </summary>
        public InvokeCategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded()
        {
        }
        ...
        internal InvokeCategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _getEntitiesRequest = If( json?.PropertyT<Carbon.Json.JsonObject>("GetEntitiesRequest"), out var __jsonGetEntitiesRequest) ? Sample.API.Models.CategoryListMetadata.FromJson(__jsonGetEntitiesRequest) : GetEntitiesRequest;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'category' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.Category(GetEntitiesRequest, onOK, onDefault, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="InvokeCategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded" /> as
        /// a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.ICategoryStatus" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.ICategoryStatus> response)
        {
            using( NoSynchronizationContext )
            {
        ...
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.ICategoryKeyListResponse" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.ICategoryKeyListResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Sample.API.Models.ICategoryKeyListResponse
