function Invoke-CategoryService {
...
')]
    [Sample.API.Models.ICategoryListMetadata]
    ${GetEntitiesRequest},
...
begin
{
  ...
  'FilterKindLengthOffsetSortAttributeSortOrderExpanded' {
    ...
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('NutanixIntentfulAPI.private\Invoke-CategoryService_FilterKindLengthOffsetSortAttributeSortOrderExpanded', [System.Management.Automation.CommandTypes]::Cmdlet)
  ...
  'FilterKindLengthOffsetSortAttributeSortOrder' {
    ...
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('NutanixIntentfulAPI.private\Invoke-CategoryService_FilterKindLengthOffsetSortAttributeSortOrder', [System.Management.Automation.CommandTypes]::Cmdlet)
        $scriptCmd = {& $wrappedCmd @PSBoundParameters }
        $steppablePipeline = $scriptCmd.GetSteppablePipeline($myInvocation.CommandOrigin)
        $steppablePipeline.Begin($PSCmdlet)
    } catch {
...
.ForwardHelpTargetName NutanixIntentfulAPI.private\Invoke-CategoryService_FilterKindLengthOffsetSortAttributeSortOrder
