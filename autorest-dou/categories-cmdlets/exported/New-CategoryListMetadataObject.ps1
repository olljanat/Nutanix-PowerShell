function New-CategoryListMetadataObject {
[CmdletBinding()]
param(
...
begin
{
    try {
        ...
        $wrappedCmd = $ExecutionContext.InvokeCommand.GetCommand('NutanixIntentfulAPI.private\New-CategoryListMetadataObject', [System.Management.Automation.CommandTypes]::Cmdlet)
...
.ForwardHelpTargetName NutanixIntentfulAPI.private\New-CategoryListMetadataObject
