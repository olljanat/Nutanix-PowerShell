namespace Sample.API.ModelCmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IChecksum))]
    public class NewChecksumObject : System.Management.Automation.PSCmdlet
    {
        /// <summary>Backing field for <see cref="Checksum" /></summary>
        private Sample.API.Models.IChecksum _checksum = new Sample.API.Models.Checksum();
