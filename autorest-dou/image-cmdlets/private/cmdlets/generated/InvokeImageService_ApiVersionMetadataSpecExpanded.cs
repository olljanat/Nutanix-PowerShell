namespace Sample.API.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Invoke-ImageService.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsLifecycle.Invoke, @"ImageService_ApiVersionMetadataSpecExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IImageIntentResponse))]
    public class InvokeImageService_ApiVersionMetadataSpecExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.IImageIntentInput _body= new Sample.API.Models.ImageIntentInput();

        /// <summary>An intentful representation of a image</summary>
        public Sample.API.Models.IImageIntentInput Body
        {
            get
            {
                return this._body;
        ...
        public string ImageDescription
        {
            set
            {
                Body.Spec = Body.Spec ?? new Sample.API.Models.Image();
        ...
        /// <returns>a duplicate instance of InvokeImageService_ApiVersionMetadataSpecExpanded</returns>
        public Sample.API.Cmdlets.InvokeImageService_ApiVersionMetadataSpecExpanded Clone()
        {
        ...
        /// <returns>an instance of InvokeImageService_ApiVersionMetadataSpecExpanded.</returns>
        public static Sample.API.Cmdlets.InvokeImageService_ApiVersionMetadataSpecExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new InvokeImageService_ApiVersionMetadataSpecExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="InvokeImageService_ApiVersionMetadataSpecExpanded" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.InvokeImageService_ApiVersionMetadataSpecExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeImageService_ApiVersionMetadataSpecExpanded" /> cmdlet class.
        /// </summary>
        public InvokeImageService_ApiVersionMetadataSpecExpanded()
        {
        }
        ...
        internal InvokeImageService_ApiVersionMetadataSpecExpanded(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _body = If( json?.PropertyT<Carbon.Json.JsonObject>("Body"), out var __jsonBody) ? Sample.API.Models.ImageIntentInput.FromJson(__jsonBody) : Body;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'images' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.Images(Body, onAccepted, onDefault, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="InvokeImageService_ApiVersionMetadataSpecExpanded" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IImageIntentResponse" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onAccepted(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IImageIntentResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onAccepted - response for 202 / application/json
                // (await response) // should be Sample.API.Models.IImageIntentResponse
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IImageStatus" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IImageStatus> response)
        {
            using( NoSynchronizationContext )
            {
