namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsLifecycle.Invoke, @"ImageService_ApiVersionMetadataSpec", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IImageIntentResponse))]
    public class InvokeImageService_ApiVersionMetadataSpec : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.IImageIntentInput _body;
        ...
        /// <returns>a duplicate instance of InvokeImageService_ApiVersionMetadataSpec</returns>
        public Sample.API.Cmdlets.InvokeImageService_ApiVersionMetadataSpec Clone()
        {
        ...
        /// <returns>an instance of InvokeImageService_ApiVersionMetadataSpec.</returns>
        public static Sample.API.Cmdlets.InvokeImageService_ApiVersionMetadataSpec FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new InvokeImageService_ApiVersionMetadataSpec(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="InvokeImageService_ApiVersionMetadataSpec" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.InvokeImageService_ApiVersionMetadataSpec FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeImageService_ApiVersionMetadataSpec" /> cmdlet class.
        /// </summary>
        public InvokeImageService_ApiVersionMetadataSpec()
        {
        }
        ...
        internal InvokeImageService_ApiVersionMetadataSpec(Carbon.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="InvokeImageService_ApiVersionMetadataSpec" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
