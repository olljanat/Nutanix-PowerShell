namespace Sample.API.Models
{
    ...
    public partial class ImageListIntentResponse
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IImageListIntentResponse.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IImageListIntentResponse.</returns>
        public static Sample.API.Models.IImageListIntentResponse FromJson(Carbon.Json.JsonNode node)
        {
        ...
        internal ImageListIntentResponse(Carbon.Json.JsonObject json)
        {
            ...
            _entities = If( json?.PropertyT<Carbon.Json.JsonArray>("entities"), out var __jsonEntities) ? If( __jsonEntities, out var __w) ? new System.Func<Sample.API.Models.IImageIntentResource[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __w, (__v)=> Sample.API.Models.ImageIntentResource.FromJson(__v)  ) ) )() : null : Entities;
            _metadata = If( json?.PropertyT<Carbon.Json.JsonObject>("metadata"), out var __jsonMetadata) ? Sample.API.Models.ImageListMetadataOutput.FromJson(__jsonMetadata) : Metadata;
            AfterFromJson(json);
        }
        /// <summary>
