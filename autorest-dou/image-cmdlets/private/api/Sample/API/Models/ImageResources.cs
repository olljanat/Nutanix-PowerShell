namespace Sample.API.Models
{
    ...
    public partial class ImageResources : Sample.API.Models.IImageResources, Microsoft.Rest.ClientRuntime.IValidates
    {
        /// <summary>Backing field for Architecture property</summary>
        ...
        /// <summary>Backing field for Checksum property</summary>
        private Sample.API.Models.IChecksum _checksum;
        ...
        /// </summary>
        public Sample.API.Models.IChecksum Checksum
        {
            get
            {
        ...
        /// <summary>Backing field for ImageType property</summary>
        ...
        /// <summary>Backing field for SourceUri property</summary>
        ...
        private Sample.API.Models.IImageVersionResources _version;

        /// <summary>The image version</summary>
        public Sample.API.Models.IImageVersionResources Version
        {
            get
            {
    ...
    public partial interface IImageResources : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        ...
        Sample.API.Models.IChecksum Checksum { get; set; }
        string ImageType { get; set; }
        string SourceUri { get; set; }
        Sample.API.Models.IImageVersionResources Version { get; set; }
    }
}