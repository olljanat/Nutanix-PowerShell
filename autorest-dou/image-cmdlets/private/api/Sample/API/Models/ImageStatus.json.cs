namespace Sample.API.Models
{
    ...
    public partial class ImageStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IImageStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IImageStatus.</returns>
        public static Sample.API.Models.IImageStatus FromJson(Carbon.Json.JsonNode node)
        {
