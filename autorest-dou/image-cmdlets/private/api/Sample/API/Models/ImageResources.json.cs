namespace Sample.API.Models
{
    ...
    public partial class ImageResources
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IImageResources.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IImageResources.</returns>
        public static Sample.API.Models.IImageResources FromJson(Carbon.Json.JsonNode node)
        {
        ...
        internal ImageResources(Carbon.Json.JsonObject json)
        {
            ...
            _version = If( json?.PropertyT<Carbon.Json.JsonObject>("version"), out var __jsonVersion) ? Sample.API.Models.ImageVersionResources.FromJson(__jsonVersion) : Version;
            AfterFromJson(json);
        }
        /// <summary>
