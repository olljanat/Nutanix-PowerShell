namespace Sample.API.Models
{
    ...
    public partial class ImageMigrateInput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IImageMigrateInput.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IImageMigrateInput.</returns>
        public static Sample.API.Models.IImageMigrateInput FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new ImageMigrateInput(json) : null;
        }
        /// <summary>
        ...
        internal ImageMigrateInput(Carbon.Json.JsonObject json)
        {
            ...
            _imageReferenceList = If( json?.PropertyT<Carbon.Json.JsonArray>("image_reference_list"), out var __jsonImageReferenceList) ? If( __jsonImageReferenceList, out var __w) ? new System.Func<Sample.API.Models.IImageReference[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __w, (__v)=> Sample.API.Models.ImageReference.FromJson(__v)  ) ) )() : null : ImageReferenceList;
            AfterFromJson(json);
        }
        /// <summary>
        ...
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.SerializationMode serializationMode)
        {
            ...
            if (null != ImageReferenceList)
            {
                ...
                foreach( var __y in ImageReferenceList )
                {
                    AddIf(__y?.ToJson(null) ,__x.Add);
                }
                container.Add("image_reference_list",__x);
            }
