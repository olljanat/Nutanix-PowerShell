namespace Sample.API.Models
{
    ...
    public partial class ImageVersionResources
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IImageVersionResources.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IImageVersionResources.</returns>
        public static Sample.API.Models.IImageVersionResources FromJson(Carbon.Json.JsonNode node)
        {
