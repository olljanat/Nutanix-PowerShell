namespace Sample.API.Models
{
    ...
    public partial class ImageDefStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IImageDefStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IImageDefStatus.</returns>
        public static Sample.API.Models.IImageDefStatus FromJson(Carbon.Json.JsonNode node)
        {
        ...
        internal ImageDefStatus(Carbon.Json.JsonObject json)
        {
            ...
            _resources = If( json?.PropertyT<Carbon.Json.JsonObject>("resources"), out var __jsonResources) ? Sample.API.Models.ImageResourcesDefStatus.FromJson(__jsonResources) : Resources;
