namespace Sample.API.Models
{
    ...
    public partial class ImageListMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IImageListMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IImageListMetadata.</returns>
        public static Sample.API.Models.IImageListMetadata FromJson(Carbon.Json.JsonNode node)
        {
