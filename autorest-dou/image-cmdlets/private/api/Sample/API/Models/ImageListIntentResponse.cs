namespace Sample.API.Models
{
    ...
    public partial class ImageListIntentResponse : Sample.API.Models.IImageListIntentResponse, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        private Sample.API.Models.IImageIntentResource[] _entities;

        public Sample.API.Models.IImageIntentResource[] Entities
        {
            get
            {
        ...
        private Sample.API.Models.IImageListMetadataOutput _metadata;

        /// <summary>
        /// All api calls that return a list will have this metadata block
        /// </summary>
        public Sample.API.Models.IImageListMetadataOutput Metadata
        {
            get
            {
    ...
    public partial interface IImageListIntentResponse : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        ...
        Sample.API.Models.IImageIntentResource[] Entities { get; set; }
        Sample.API.Models.IImageListMetadataOutput Metadata { get; set; }
    }
}