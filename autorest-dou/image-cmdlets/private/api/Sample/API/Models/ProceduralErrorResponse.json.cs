namespace Sample.API.Models
{
    ...
    public partial class ProceduralErrorResponse
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IProceduralErrorResponse.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IProceduralErrorResponse.</returns>
        public static Sample.API.Models.IProceduralErrorResponse FromJson(Carbon.Json.JsonNode node)
        {
