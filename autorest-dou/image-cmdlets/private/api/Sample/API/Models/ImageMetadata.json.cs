namespace Sample.API.Models
{
    ...
    public partial class ImageMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IImageMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IImageMetadata.</returns>
        public static Sample.API.Models.IImageMetadata FromJson(Carbon.Json.JsonNode node)
        {
