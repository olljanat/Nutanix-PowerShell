namespace Sample.API.Models
{
    ...
    public partial class ImageResourcesDefStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IImageResourcesDefStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IImageResourcesDefStatus.</returns>
        public static Sample.API.Models.IImageResourcesDefStatus FromJson(Carbon.Json.JsonNode node)
        {
        ...
        internal ImageResourcesDefStatus(Carbon.Json.JsonObject json)
        {
            ...
            _checksum = If( json?.PropertyT<Carbon.Json.JsonObject>("checksum"), out var __jsonChecksum) ? Sample.API.Models.Checksum.FromJson(__jsonChecksum) : Checksum;
            ...
            _version = If( json?.PropertyT<Carbon.Json.JsonObject>("version"), out var __jsonVersion) ? Sample.API.Models.ImageVersionStatus.FromJson(__jsonVersion) : Version;
            AfterFromJson(json);
        }
        /// <summary>
