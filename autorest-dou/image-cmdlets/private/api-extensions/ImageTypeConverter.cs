namespace Sample.API.Models
{
    ...
    /// </summary>
    public class ImageTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                Image.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                Resources = ImageResourcesTypeConverter.ConvertFrom(sourceValue.Resources),
                };
            }
            catch
            {
