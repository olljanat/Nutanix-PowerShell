namespace Sample.API.ModelCmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.ISubnet))]
    public class NewSubnetObject : System.Management.Automation.PSCmdlet
    {
        /// <summary>Backing field for <see cref="Subnet" /></summary>
        private Sample.API.Models.ISubnet _subnet = new Sample.API.Models.Subnet();
        ...
        public string AvailabilityZoneReferenceKind
        {
            set
            {
                _subnet.AvailabilityZoneReference = _subnet.AvailabilityZoneReference ?? new Sample.API.Models.AvailabilityZoneReference();
        ...
        public string ClusterReferenceKind
        {
            set
            {
                _subnet.ClusterReference = _subnet.ClusterReference ?? new Sample.API.Models.ClusterReference();
        ...
        public Sample.API.Models.ISubnetResources Resources
        {
            set
            {
