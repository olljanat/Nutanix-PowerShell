namespace Sample.API.ModelCmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.ISubnetResources))]
    public class NewSubnetResourcesObject : System.Management.Automation.PSCmdlet
    {
        ...
        private Sample.API.Models.ISubnetResources _subnetResources = new Sample.API.Models.SubnetResources();
        ...
        public string NetworkFunctionChainReferenceKind
        {
            set
            {
                _subnetResources.NetworkFunctionChainReference = _subnetResources.NetworkFunctionChainReference ?? new Sample.API.Models.NetworkFunctionChainReference();
