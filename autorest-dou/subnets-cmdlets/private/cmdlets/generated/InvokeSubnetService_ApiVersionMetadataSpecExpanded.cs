namespace Sample.API.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Invoke-SubnetService.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsLifecycle.Invoke, @"SubnetService_ApiVersionMetadataSpecExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.ISubnetIntentResponse))]
    public class InvokeSubnetService_ApiVersionMetadataSpecExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.ISubnetIntentInput _body= new Sample.API.Models.SubnetIntentInput();

        /// <summary>An intentful representation of a subnet</summary>
        public Sample.API.Models.ISubnetIntentInput Body
        {
            get
            {
                return this._body;
        ...
        /// <returns>a duplicate instance of InvokeSubnetService_ApiVersionMetadataSpecExpanded</returns>
        public Sample.API.Cmdlets.InvokeSubnetService_ApiVersionMetadataSpecExpanded Clone()
        {
        ...
        /// <returns>an instance of InvokeSubnetService_ApiVersionMetadataSpecExpanded.</returns>
        public static Sample.API.Cmdlets.InvokeSubnetService_ApiVersionMetadataSpecExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new InvokeSubnetService_ApiVersionMetadataSpecExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="InvokeSubnetService_ApiVersionMetadataSpecExpanded" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.InvokeSubnetService_ApiVersionMetadataSpecExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeSubnetService_ApiVersionMetadataSpecExpanded" /> cmdlet class.
        /// </summary>
        public InvokeSubnetService_ApiVersionMetadataSpecExpanded()
        {
        }
        ...
        internal InvokeSubnetService_ApiVersionMetadataSpecExpanded(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _body = If( json?.PropertyT<Carbon.Json.JsonObject>("Body"), out var __jsonBody) ? Sample.API.Models.SubnetIntentInput.FromJson(__jsonBody) : Body;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'subnets' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.Subnets(Body, onAccepted, onDefault, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="InvokeSubnetService_ApiVersionMetadataSpecExpanded" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.ISubnetIntentResponse" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onAccepted(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.ISubnetIntentResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onAccepted - response for 202 / application/json
                // (await response) // should be Sample.API.Models.ISubnetIntentResponse
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.ISubnetStatus" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.ISubnetStatus> response)
        {
            using( NoSynchronizationContext )
            {
