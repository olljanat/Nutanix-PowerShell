namespace Sample.API.Models
{
    ...
    public partial class ProjectReference
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IProjectReference.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IProjectReference.</returns>
        public static Sample.API.Models.IProjectReference FromJson(Carbon.Json.JsonNode node)
        {
