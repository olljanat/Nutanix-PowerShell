namespace Sample.API.Models
{
    ...
    public partial class IpConfig : Sample.API.Models.IIpConfig, Microsoft.Rest.ClientRuntime.IValidates
    {
        /// <summary>Backing field for DefaultGatewayIp property</summary>
        ...
        /// <summary>Backing field for DhcpOptions property</summary>
        private Sample.API.Models.IDhcpOptions _dhcpOptions;
        ...
        /// <summary>Backing field for DhcpServerAddress property</summary>
        private Sample.API.Models.IAddress _dhcpServerAddress;

        /// <summary>Host address.</summary>
        public Sample.API.Models.IAddress DhcpServerAddress
        {
            get
            {
        ...
        /// <summary>Backing field for PoolList property</summary>
        private Sample.API.Models.IIpPool[] _poolList;
        ...
        /// <summary>Backing field for PrefixLength property</summary>
        ...
        /// <summary>Backing field for SubnetIp property</summary>
    ...
    public partial interface IIpConfig : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        ...
        Sample.API.Models.IDhcpOptions DhcpOptions { get; set; }
        Sample.API.Models.IAddress DhcpServerAddress { get; set; }
        Sample.API.Models.IIpPool[] PoolList { get; set; }
