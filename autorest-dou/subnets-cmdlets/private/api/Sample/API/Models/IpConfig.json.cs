namespace Sample.API.Models
{
    ...
    public partial class IpConfig
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IIpConfig.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IIpConfig.</returns>
        public static Sample.API.Models.IIpConfig FromJson(Carbon.Json.JsonNode node)
        {
        ...
        internal IpConfig(Carbon.Json.JsonObject json)
        {
            ...
            _dhcpOptions = If( json?.PropertyT<Carbon.Json.JsonObject>("dhcp_options"), out var __jsonDhcpOptions) ? Sample.API.Models.DhcpOptions.FromJson(__jsonDhcpOptions) : DhcpOptions;
            _dhcpServerAddress = If( json?.PropertyT<Carbon.Json.JsonObject>("dhcp_server_address"), out var __jsonDhcpServerAddress) ? Sample.API.Models.Address.FromJson(__jsonDhcpServerAddress) : DhcpServerAddress;
            _poolList = If( json?.PropertyT<Carbon.Json.JsonArray>("pool_list"), out var __jsonPoolList) ? If( __jsonPoolList, out var __w) ? new System.Func<Sample.API.Models.IIpPool[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __w, (__v)=> Sample.API.Models.IpPool.FromJson(__v)  ) ) )() : null : PoolList;
        ...
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.SerializationMode serializationMode)
        {
            ...
            if (null != PoolList)
            {
                ...
                foreach( var __y in PoolList )
                {
                    AddIf(__y?.ToJson(null) ,__x.Add);
                }
                container.Add("pool_list",__x);
            }
