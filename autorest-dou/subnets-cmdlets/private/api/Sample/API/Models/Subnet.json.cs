namespace Sample.API.Models
{
    ...
    public partial class Subnet
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ISubnet.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ISubnet.</returns>
        public static Sample.API.Models.ISubnet FromJson(Carbon.Json.JsonNode node)
        {
        ...
        internal Subnet(Carbon.Json.JsonObject json)
        {
            ...
            _resources = If( json?.PropertyT<Carbon.Json.JsonObject>("resources"), out var __jsonResources) ? Sample.API.Models.SubnetResources.FromJson(__jsonResources) : Resources;
            AfterFromJson(json);
        }
        /// <summary>
