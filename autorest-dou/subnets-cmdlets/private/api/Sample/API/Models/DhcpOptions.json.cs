namespace Sample.API.Models
{
    ...
    public partial class DhcpOptions
    {
        ...
        internal DhcpOptions(Carbon.Json.JsonObject json)
        {
            ...
            _domainNameServerList = If( json?.PropertyT<Carbon.Json.JsonArray>("domain_name_server_list"), out var __jsonDomainNameServerList) ? If( __jsonDomainNameServerList, out var __w) ? new System.Func<string[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __w, (__v)=> __v is Carbon.Json.JsonString __u ? (string)__u : null ) ) )() : null : DomainNameServerList;
            _domainSearchList = If( json?.PropertyT<Carbon.Json.JsonArray>("domain_search_list"), out var __jsonDomainSearchList) ? If( __jsonDomainSearchList, out var __r) ? new System.Func<string[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __r, (__q)=> __q is Carbon.Json.JsonString __p ? (string)__p : null ) ) )() : null : DomainSearchList;
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IDhcpOptions.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IDhcpOptions.</returns>
        public static Sample.API.Models.IDhcpOptions FromJson(Carbon.Json.JsonNode node)
        {
