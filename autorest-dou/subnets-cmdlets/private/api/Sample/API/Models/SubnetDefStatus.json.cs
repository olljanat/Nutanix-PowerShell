namespace Sample.API.Models
{
    ...
    public partial class SubnetDefStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ISubnetDefStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ISubnetDefStatus.</returns>
        public static Sample.API.Models.ISubnetDefStatus FromJson(Carbon.Json.JsonNode node)
        {
        ...
        internal SubnetDefStatus(Carbon.Json.JsonObject json)
        {
            ...
            _resources = If( json?.PropertyT<Carbon.Json.JsonObject>("resources"), out var __jsonResources) ? Sample.API.Models.SubnetResourcesDefStatus.FromJson(__jsonResources) : Resources;
