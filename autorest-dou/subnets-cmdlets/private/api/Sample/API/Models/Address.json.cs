namespace Sample.API.Models
{
    ...
    public partial class Address
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IAddress.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IAddress.</returns>
        public static Sample.API.Models.IAddress FromJson(Carbon.Json.JsonNode node)
        {
