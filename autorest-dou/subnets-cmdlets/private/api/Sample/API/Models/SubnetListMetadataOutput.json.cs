namespace Sample.API.Models
{
    ...
    public partial class SubnetListMetadataOutput
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ISubnetListMetadataOutput.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ISubnetListMetadataOutput.</returns>
        public static Sample.API.Models.ISubnetListMetadataOutput FromJson(Carbon.Json.JsonNode node)
        {
