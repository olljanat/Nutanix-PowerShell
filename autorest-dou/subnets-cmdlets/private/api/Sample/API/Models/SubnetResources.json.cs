namespace Sample.API.Models
{
    ...
    public partial class SubnetResources
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ISubnetResources.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ISubnetResources.</returns>
        public static Sample.API.Models.ISubnetResources FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new SubnetResources(json) : null;
        }
        /// <summary>
        /// Deserializes a Carbon.Json.JsonObject into a new instance of <see cref="SubnetResources" />.
        /// </summary>
        /// <param name="json">A Carbon.Json.JsonObject instance to deserialize from.</param>
        internal SubnetResources(Carbon.Json.JsonObject json)
        {
            ...
            _ipConfig = If( json?.PropertyT<Carbon.Json.JsonObject>("ip_config"), out var __jsonIpConfig) ? Sample.API.Models.IpConfig.FromJson(__jsonIpConfig) : IpConfig;
