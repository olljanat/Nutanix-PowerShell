namespace Sample.API.Models
{
    ...
    public partial class SubnetDefStatus : Sample.API.Models.ISubnetDefStatus, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        private Sample.API.Models.ISubnetResourcesDefStatus _resources;

        /// <summary>Subnet creation/modification status.</summary>
        public Sample.API.Models.ISubnetResourcesDefStatus Resources
        {
            get
            {
    ...
    public partial interface ISubnetDefStatus : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        ...
        string Name { get; set; }
        Sample.API.Models.ISubnetResourcesDefStatus Resources { get; set; }
