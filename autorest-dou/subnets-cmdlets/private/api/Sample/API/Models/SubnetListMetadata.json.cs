namespace Sample.API.Models
{
    ...
    public partial class SubnetListMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ISubnetListMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ISubnetListMetadata.</returns>
        public static Sample.API.Models.ISubnetListMetadata FromJson(Carbon.Json.JsonNode node)
        {
