namespace Sample.API.Models
{
    ...
    public partial class SubnetMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ISubnetMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ISubnetMetadata.</returns>
        public static Sample.API.Models.ISubnetMetadata FromJson(Carbon.Json.JsonNode node)
        {
