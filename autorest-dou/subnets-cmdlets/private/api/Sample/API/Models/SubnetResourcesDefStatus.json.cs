namespace Sample.API.Models
{
    ...
    public partial class SubnetResourcesDefStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ISubnetResourcesDefStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ISubnetResourcesDefStatus.</returns>
        public static Sample.API.Models.ISubnetResourcesDefStatus FromJson(Carbon.Json.JsonNode node)
        {
