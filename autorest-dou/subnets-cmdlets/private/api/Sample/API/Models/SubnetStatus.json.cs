namespace Sample.API.Models
{
    ...
    public partial class SubnetStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.ISubnetStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.ISubnetStatus.</returns>
        public static Sample.API.Models.ISubnetStatus FromJson(Carbon.Json.JsonNode node)
        {
