namespace Sample.API.Models
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="SubnetIntentResource" />
    /// </summary>
    public class SubnetIntentResourceTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        /// parameter.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="SubnetIntentResource"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="SubnetIntentResource" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="SubnetIntentResource" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        ...
        /// /> and <see cref="ignoreCase" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="SubnetIntentResource" />.</param>
        /// <returns>
        /// an instance of <see cref="SubnetIntentResource" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                SubnetIntentResource.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new SubnetIntentResource
                {
                ApiVersion = sourceValue.ApiVersion,
                Metadata = SubnetMetadataTypeConverter.ConvertFrom(sourceValue.Metadata),
                Spec = SubnetTypeConverter.ConvertFrom(sourceValue.Spec),
                Status = SubnetDefStatusTypeConverter.ConvertFrom(sourceValue.Status),
                };
            }
            catch
            {
