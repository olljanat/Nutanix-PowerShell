namespace Sample.API.Models
{
    ...
    /// </summary>
    public class SubnetTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                Subnet.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                Resources = SubnetResourcesTypeConverter.ConvertFrom(sourceValue.Resources),
                };
            }
            catch
            {
