namespace Sample.API.Cmdlets
{
    ...
    public class GetServiceVm_VmUuid : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetServiceVm_VmUuid Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetServiceVm_VmUuid FromJson(Carbon.Json.JsonNode node)
        {
        ...
        public static Sample.API.Cmdlets.GetServiceVm_VmUuid FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.GetVm(Uuid, onOK, onNotFound, onDefault, this, Pipeline, this.username, this.password);
        ...
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IVmIntentResponse> response)
        {
            using( NoSynchronizationContext )
            {
