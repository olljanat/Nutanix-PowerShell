namespace Sample.API.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Set-ServiceRecoveryPoint.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"ServiceRecoveryPoint_RecoveryPointUuidApiVersionMetadataSpec", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IVmRecoveryPointIntentResponse))]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IVmRecoveryPointStatus))]
    public class SetServiceRecoveryPoint_RecoveryPointUuidApiVersionMetadataSpec : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.IVmRecoveryPointIntentInput _body;

        /// <summary>An intentful representation of a vm_recovery_point</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "An intentful representation of a vm_recovery_point", ValueFromPipeline = true)]
        public Sample.API.Models.IVmRecoveryPointIntentInput Body
        {
            get
            {
                return this._body;
        ...
        /// <returns>
        /// a duplicate instance of SetServiceRecoveryPoint_RecoveryPointUuidApiVersionMetadataSpec
        /// </returns>
        public Sample.API.Cmdlets.SetServiceRecoveryPoint_RecoveryPointUuidApiVersionMetadataSpec Clone()
        {
        ...
        /// <returns>an instance of SetServiceRecoveryPoint_RecoveryPointUuidApiVersionMetadataSpec.</returns>
        public static Sample.API.Cmdlets.SetServiceRecoveryPoint_RecoveryPointUuidApiVersionMetadataSpec FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new SetServiceRecoveryPoint_RecoveryPointUuidApiVersionMetadataSpec(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="SetServiceRecoveryPoint_RecoveryPointUuidApiVersionMetadataSpec" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.SetServiceRecoveryPoint_RecoveryPointUuidApiVersionMetadataSpec FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateRecoveryPoint' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.UpdateRecoveryPoint(Uuid, Body, onOK, onNotFound, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetServiceRecoveryPoint_RecoveryPointUuidApiVersionMetadataSpec" /> cmdlet
        /// class.
        /// </summary>
        public SetServiceRecoveryPoint_RecoveryPointUuidApiVersionMetadataSpec()
        {
        }
        ...
        internal SetServiceRecoveryPoint_RecoveryPointUuidApiVersionMetadataSpec(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _uuid = If( json?.PropertyT<Carbon.Json.JsonString>("Uuid"), out var __jsonUuid) ? (string)__jsonUuid : (string)Uuid;
            _body = If( json?.PropertyT<Carbon.Json.JsonObject>("Body"), out var __jsonBody) ? Sample.API.Models.VmRecoveryPointIntentInput.FromJson(__jsonBody) : Body;
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="SetServiceRecoveryPoint_RecoveryPointUuidApiVersionMetadataSpec" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IVmRecoveryPointStatus" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IVmRecoveryPointStatus> response)
        {
            using( NoSynchronizationContext )
            {
        ...
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onNotFound(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IVmRecoveryPointStatus> response)
        {
            using( NoSynchronizationContext )
            {
                // onNotFound - response for 404 / application/json
                // (await response) // should be Sample.API.Models.IVmRecoveryPointStatus
                WriteObject(await response);
            }
        }
        /// <summary>a delegate that is called when the remote service returns 200 (OK).</summary>
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.IVmRecoveryPointIntentResponse" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.IVmRecoveryPointIntentResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Sample.API.Models.IVmRecoveryPointIntentResponse
                WriteObject(await response);
            }
        }
    }
