namespace Sample.API.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Set-ServiceVm.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"ServiceVm_VmUuidApiVersionMetadataSpecExpanded", SupportsShouldProcess = true)]
    ...
    public class SetServiceVm_VmUuidApiVersionMetadataSpecExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.IVmIntentInput _body= new Sample.API.Models.VmIntentInput();

        /// <summary>An intentful representation of a vm</summary>
        public Sample.API.Models.IVmIntentInput Body
        {
            get
            {
                return this._body;
        ...
        /// <returns>a duplicate instance of SetServiceVm_VmUuidApiVersionMetadataSpecExpanded</returns>
        public Sample.API.Cmdlets.SetServiceVm_VmUuidApiVersionMetadataSpecExpanded Clone()
        {
        ...
        /// <returns>an instance of SetServiceVm_VmUuidApiVersionMetadataSpecExpanded.</returns>
        public static Sample.API.Cmdlets.SetServiceVm_VmUuidApiVersionMetadataSpecExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new SetServiceVm_VmUuidApiVersionMetadataSpecExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="SetServiceVm_VmUuidApiVersionMetadataSpecExpanded" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.SetServiceVm_VmUuidApiVersionMetadataSpecExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateVm' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.UpdateVm(Uuid, Body, onAccepted, onNotFound, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetServiceVm_VmUuidApiVersionMetadataSpecExpanded" /> cmdlet class.
        /// </summary>
        public SetServiceVm_VmUuidApiVersionMetadataSpecExpanded()
        {
        }
        ...
        internal SetServiceVm_VmUuidApiVersionMetadataSpecExpanded(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _uuid = If( json?.PropertyT<Carbon.Json.JsonString>("Uuid"), out var __jsonUuid) ? (string)__jsonUuid : (string)Uuid;
            _body = If( json?.PropertyT<Carbon.Json.JsonObject>("Body"), out var __jsonBody) ? Sample.API.Models.VmIntentInput.FromJson(__jsonBody) : Body;
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="SetServiceVm_VmUuidApiVersionMetadataSpecExpanded" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
