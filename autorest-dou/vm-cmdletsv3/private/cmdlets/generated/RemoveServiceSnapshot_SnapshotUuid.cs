namespace Sample.API.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Remove-ServiceSnapshot.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"ServiceSnapshot_SnapshotUuid", SupportsShouldProcess = true)]
    ...
    public class RemoveServiceSnapshot_SnapshotUuid : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveServiceSnapshot_SnapshotUuid</returns>
        public Sample.API.Cmdlets.RemoveServiceSnapshot_SnapshotUuid Clone()
        {
        ...
        /// <returns>an instance of RemoveServiceSnapshot_SnapshotUuid.</returns>
        public static Sample.API.Cmdlets.RemoveServiceSnapshot_SnapshotUuid FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveServiceSnapshot_SnapshotUuid(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="RemoveServiceSnapshot_SnapshotUuid" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.RemoveServiceSnapshot_SnapshotUuid FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DeleteSnapshot' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.DeleteSnapshot(Uuid, onAccepted, onNotFound, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveServiceSnapshot_SnapshotUuid" /> cmdlet class.
        /// </summary>
        public RemoveServiceSnapshot_SnapshotUuid()
        {
        }
        ...
        internal RemoveServiceSnapshot_SnapshotUuid(Carbon.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="RemoveServiceSnapshot_SnapshotUuid" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
