namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"ServiceSnapshot_SnapshotApiVersionMetadataSpec", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IVmSnapshotIntentResponse))]
    public class NewServiceSnapshot_SnapshotApiVersionMetadataSpec : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of NewServiceSnapshot_SnapshotApiVersionMetadataSpec</returns>
        public Sample.API.Cmdlets.NewServiceSnapshot_SnapshotApiVersionMetadataSpec Clone()
        {
        ...
        /// <returns>an instance of NewServiceSnapshot_SnapshotApiVersionMetadataSpec.</returns>
        public static Sample.API.Cmdlets.NewServiceSnapshot_SnapshotApiVersionMetadataSpec FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewServiceSnapshot_SnapshotApiVersionMetadataSpec(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewServiceSnapshot_SnapshotApiVersionMetadataSpec" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.NewServiceSnapshot_SnapshotApiVersionMetadataSpec FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewServiceSnapshot_SnapshotApiVersionMetadataSpec" /> cmdlet class.
        /// </summary>
        public NewServiceSnapshot_SnapshotApiVersionMetadataSpec()
        {
        }
        ...
        internal NewServiceSnapshot_SnapshotApiVersionMetadataSpec(Carbon.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewServiceSnapshot_SnapshotApiVersionMetadataSpec" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
