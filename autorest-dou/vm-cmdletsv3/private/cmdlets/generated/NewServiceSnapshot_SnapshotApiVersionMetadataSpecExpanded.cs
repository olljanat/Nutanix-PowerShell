namespace Sample.API.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet New-ServiceSnapshot.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"ServiceSnapshot_SnapshotApiVersionMetadataSpecExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IVmSnapshotIntentResponse))]
    public class NewServiceSnapshot_SnapshotApiVersionMetadataSpecExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.IVmSnapshotIntentInput _body= new Sample.API.Models.VmSnapshotIntentInput();
        ...
        /// <returns>
        /// a duplicate instance of NewServiceSnapshot_SnapshotApiVersionMetadataSpecExpanded
        /// </returns>
        public Sample.API.Cmdlets.NewServiceSnapshot_SnapshotApiVersionMetadataSpecExpanded Clone()
        {
        ...
        /// <returns>an instance of NewServiceSnapshot_SnapshotApiVersionMetadataSpecExpanded.</returns>
        public static Sample.API.Cmdlets.NewServiceSnapshot_SnapshotApiVersionMetadataSpecExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewServiceSnapshot_SnapshotApiVersionMetadataSpecExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewServiceSnapshot_SnapshotApiVersionMetadataSpecExpanded" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.NewServiceSnapshot_SnapshotApiVersionMetadataSpecExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewServiceSnapshot_SnapshotApiVersionMetadataSpecExpanded" /> cmdlet class.
        /// </summary>
        public NewServiceSnapshot_SnapshotApiVersionMetadataSpecExpanded()
        {
        }
        ...
        internal NewServiceSnapshot_SnapshotApiVersionMetadataSpecExpanded(Carbon.Json.JsonObject json)
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'NewSnapshot' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                await this.Client.NewSnapshot(Body, onAccepted, onDefault, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewServiceSnapshot_SnapshotApiVersionMetadataSpecExpanded" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
