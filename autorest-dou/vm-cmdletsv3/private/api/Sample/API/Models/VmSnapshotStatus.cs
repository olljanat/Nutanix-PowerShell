namespace Sample.API.Models
{
    ...
    /// report.
    /// </summary>
    public partial class VmSnapshotStatus : Sample.API.Models.IVmSnapshotStatus, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        /// <summary>Creates an new <see cref="VmSnapshotStatus" /> instance.</summary>
        public VmSnapshotStatus()
        {
        }
    }
    /// The status of a REST API call. Only used when there is a failure to
    /// report.
    public partial interface IVmSnapshotStatus : Microsoft.Rest.ClientRuntime.IJsonSerializable {
