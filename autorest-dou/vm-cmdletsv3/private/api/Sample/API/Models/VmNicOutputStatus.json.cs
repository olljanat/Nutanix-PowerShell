namespace Sample.API.Models
{
    ...
    public partial class VmNicOutputStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IVmNicOutputStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IVmNicOutputStatus.</returns>
        public static Sample.API.Models.IVmNicOutputStatus FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new VmNicOutputStatus(json) : null;
        }
        /// <summary>
        /// Serializes this instance of <see cref="VmNicOutputStatus" /> into a <see cref="Carbon.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Carbon.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Microsoft.Rest.ClientRuntime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="VmNicOutputStatus" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != FloatingIp ? (Carbon.Json.JsonNode) new Carbon.Json.JsonString(FloatingIp) : null, "floating_ip" ,container.Add );
            if (null != IpEndpointList)
            {
                var __x = new Carbon.Json.XNodeArray();
                foreach( var __y in IpEndpointList )
                {
                    AddIf(__y?.ToJson(null) ,__x.Add);
                }
                container.Add("ip_endpoint_list",__x);
            }
        ...
        /// <summary>
        /// Deserializes a Carbon.Json.JsonObject into a new instance of <see cref="VmNicOutputStatus" />.
        /// </summary>
        /// <param name="json">A Carbon.Json.JsonObject instance to deserialize from.</param>
        internal VmNicOutputStatus(Carbon.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            _floatingIp = If( json?.PropertyT<Carbon.Json.JsonString>("floating_ip"), out var __jsonFloatingIp) ? (string)__jsonFloatingIp : (string)FloatingIp;
            _ipEndpointList = If( json?.PropertyT<Carbon.Json.JsonArray>("ip_endpoint_list"), out var __jsonIpEndpointList) ? If( __jsonIpEndpointList, out var __w) ? new System.Func<Sample.API.Models.IIpAddress[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __w, (__v)=> Sample.API.Models.IpAddress.FromJson(__v)  ) ) )() : null : IpEndpointList;
