namespace Sample.API.Models
{
    ...
    public partial class VmResourcesDefStatus
    {
        ...
        internal VmResourcesDefStatus(Carbon.Json.JsonObject json)
        {
            ...
            _gpuList = If( json?.PropertyT<Carbon.Json.JsonArray>("gpu_list"), out var __jsonGpuList) ? If( __jsonGpuList, out var __r) ? new System.Func<Sample.API.Models.IVmGpuOutputStatus[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __r, (__q)=> Sample.API.Models.VmGpuOutputStatus.FromJson(__q)  ) ) )() : null : GpuList;
            ...
            _nicList = If( json?.PropertyT<Carbon.Json.JsonArray>("nic_list"), out var __jsonNicList) ? If( __jsonNicList, out var __m) ? new System.Func<Sample.API.Models.IVmNicOutputStatus[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __m, (__l)=> Sample.API.Models.VmNicOutputStatus.FromJson(__l)  ) ) )() : null : NicList;
