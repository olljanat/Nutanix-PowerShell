namespace Sample.API.Models
{
    ...
    public partial class GuestCustomizationCloudInit
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Sample.API.Models.IGuestCustomizationCloudInit.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.IGuestCustomizationCloudInit.</returns>
        public static Sample.API.Models.IGuestCustomizationCloudInit FromJson(Carbon.Json.JsonNode node)
        {
