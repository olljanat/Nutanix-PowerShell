namespace Sample.API.Models
{
    ...
    /// report.
    /// </summary>
    public partial class VmRecoveryPointStatus : Sample.API.Models.IVmRecoveryPointStatus, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        /// <summary>Creates an new <see cref="VmRecoveryPointStatus" /> instance.</summary>
        public VmRecoveryPointStatus()
        {
        }
    }
    /// The status of a REST API call. Only used when there is a failure to
    /// report.
    public partial interface IVmRecoveryPointStatus : Microsoft.Rest.ClientRuntime.IJsonSerializable {
