namespace Nutanix.Powershell.Models
{
    ...
    public partial class NetworkSecurityRuleIntentResponse
    {
        ...
        public static Nutanix.Powershell.Models.INetworkSecurityRuleIntentResponse FromJsonString(string jsonText) => FromJson(Carbon.Json.JsonNode.Parse(jsonText));
