namespace Nutanix.Powershell.Models
{
    ...
    public partial class CategoryQueryResponseResultsItemType
    {
        ...
        public static Nutanix.Powershell.Models.ICategoryQueryResponseResultsItemType FromJsonString(string jsonText) => FromJson(Carbon.Json.JsonNode.Parse(jsonText));
