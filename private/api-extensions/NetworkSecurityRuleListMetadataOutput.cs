namespace Nutanix.Powershell.Models
{
    ...
    public partial class NetworkSecurityRuleListMetadataOutput
    {
        ...
        public static Nutanix.Powershell.Models.INetworkSecurityRuleListMetadataOutput FromJsonString(string jsonText) => FromJson(Carbon.Json.JsonNode.Parse(jsonText));
