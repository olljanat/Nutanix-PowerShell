namespace Nutanix.Powershell.Models
{
    ...
    public partial class NetworkSecurityRuleResourcesQuarantineRule
    {
        ...
        public static Nutanix.Powershell.Models.INetworkSecurityRuleResourcesQuarantineRule FromJsonString(string jsonText) => FromJson(Carbon.Json.JsonNode.Parse(jsonText));
