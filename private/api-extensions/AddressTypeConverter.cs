namespace Nutanix.Powershell.Models
{
    ...
    /// </summary>
    public class AddressTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                Address.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new Address
                {
                Fqdn = sourceValue.Fqdn,
                Ip = sourceValue.Ip,
                Ipv6 = sourceValue.Ipv6,
