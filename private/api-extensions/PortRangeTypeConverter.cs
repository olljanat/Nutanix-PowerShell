namespace Nutanix.Powershell.Models
{
    ...
    /// </summary>
    public class PortRangeTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                PortRange.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                {
                EndPort = sourceValue.EndPort,
                StartPort = sourceValue.StartPort,
                };
            }
            catch
            {
