namespace Nutanix.Powershell.Models
{
    ...
    /// </summary>
    public class CredentialsTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                Credentials.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                {
                Password = sourceValue.Password,
                Username = sourceValue.Username,
                };
            }
            catch
            {
