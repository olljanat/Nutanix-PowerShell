namespace Nutanix.Powershell.Models
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="MulticlusterConfigIntentResponse" />
    /// </summary>
    public class MulticlusterConfigIntentResponseTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        /// parameter.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="MulticlusterConfigIntentResponse"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="MulticlusterConfigIntentResponse" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="MulticlusterConfigIntentResponse" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        ...
        /// /> and <see cref="ignoreCase" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="MulticlusterConfigIntentResponse" />.</param>
        /// <returns>
        /// an instance of <see cref="MulticlusterConfigIntentResponse" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                MulticlusterConfigIntentResponse.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new MulticlusterConfigIntentResponse
                {
                ApiVersion = sourceValue.ApiVersion,
                Metadata = MulticlusterConfigMetadataTypeConverter.ConvertFrom(sourceValue.Metadata),
                Spec = MulticlusterConfigSpecTypeConverter.ConvertFrom(sourceValue.Spec),
                Status = MulticlusterConfigDefStatusTypeConverter.ConvertFrom(sourceValue.Status),
                };
            }
            catch
            {
