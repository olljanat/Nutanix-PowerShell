namespace Nutanix.Powershell.Models
{
    ...
    public partial class PlacementSpec
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Nutanix.Powershell.Models.IPlacementSpec.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Nutanix.Powershell.Models.IPlacementSpec.</returns>
        public static Nutanix.Powershell.Models.IPlacementSpec FromJson(Carbon.Json.JsonNode node)
        {
        ...
        internal PlacementSpec(Carbon.Json.JsonObject json)
        {
            ...
            _entitySpecList = If( json?.PropertyT<Carbon.Json.JsonArray>("entity_spec_list"), out var __jsonEntitySpecList) ? If( __jsonEntitySpecList, out var __v) ? new System.Func<Nutanix.Powershell.Models.IEntitySpec[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __v, (__u)=> Nutanix.Powershell.Models.EntitySpec.FromJson(__u)  ) ) )() : null : EntitySpecList;
            _probableClusterReference = If( json?.PropertyT<Carbon.Json.JsonObject>("probable_cluster_reference"), out var __jsonProbableClusterReference) ? Nutanix.Powershell.Models.ClusterReference.FromJson(__jsonProbableClusterReference) : ProbableClusterReference;
