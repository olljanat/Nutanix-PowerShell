namespace Nutanix.Powershell.Models
{
    ...
    public partial class EntitySpec
    {
        ...
        internal EntitySpec(Carbon.Json.JsonObject json)
        {
            ...
            _categoryList = If( json?.PropertyT<Carbon.Json.JsonArray>("category_list"), out var __jsonCategoryList) ? If( __jsonCategoryList, out var __v) ? new System.Func<Nutanix.Powershell.Models.IEntitySpecCategoryListItemType[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __v, (__u)=> Nutanix.Powershell.Models.EntitySpecCategoryListItemType.FromJson(__u)  ) ) )() : null : CategoryList;
            _vmReference = If( json?.PropertyT<Carbon.Json.JsonObject>("vm_reference"), out var __jsonVmReference) ? Nutanix.Powershell.Models.VmReference.FromJson(__jsonVmReference) : VmReference;
            _vmSpec = If( json?.PropertyT<Carbon.Json.JsonObject>("vm_spec"), out var __jsonVmSpec) ? Nutanix.Powershell.Models.Vm.FromJson(__jsonVmSpec) : VmSpec;
            AfterFromJson(json);
        }
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Nutanix.Powershell.Models.IEntitySpec.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Nutanix.Powershell.Models.IEntitySpec.</returns>
        public static Nutanix.Powershell.Models.IEntitySpec FromJson(Carbon.Json.JsonNode node)
        {
