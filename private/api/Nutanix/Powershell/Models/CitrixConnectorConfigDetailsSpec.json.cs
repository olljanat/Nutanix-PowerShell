namespace Nutanix.Powershell.Models
{
    ...
    public partial class CitrixConnectorConfigDetailsSpec
    {
        ...
        internal CitrixConnectorConfigDetailsSpec(Carbon.Json.JsonObject json)
        {
            ...
            _resourceLocation = If( json?.PropertyT<Carbon.Json.JsonObject>("resource_location"), out var __jsonResourceLocation) ? Nutanix.Powershell.Models.CitrixResourceLocationSpec.FromJson(__jsonResourceLocation) : ResourceLocation;
            AfterFromJson(json);
        }
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Nutanix.Powershell.Models.ICitrixConnectorConfigDetailsSpec.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Nutanix.Powershell.Models.ICitrixConnectorConfigDetailsSpec.</returns>
        public static Nutanix.Powershell.Models.ICitrixConnectorConfigDetailsSpec FromJson(Carbon.Json.JsonNode node)
        {
