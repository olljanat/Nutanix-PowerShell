namespace Nutanix.Powershell.Models
{
    ...
    /// </summary>
    public partial class ClusterDomainServer : Nutanix.Powershell.Models.IClusterDomainServer, Microsoft.Rest.ClientRuntime.IValidates
    {
        /// <summary>Backing field for <see cref="DomainCredentials" /> property.</summary>
        private Nutanix.Powershell.Models.ICredentials _domainCredentials;

        /// <summary>Credentials to login server</summary>
        public Nutanix.Powershell.Models.ICredentials DomainCredentials
        {
            get
            {
    ...
    public partial interface IClusterDomainServer : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        Nutanix.Powershell.Models.ICredentials DomainCredentials { get; set; }
        string Name { get; set; }
