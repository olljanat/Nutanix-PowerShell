namespace Nutanix.Powershell.Models
{
    ...
    /// report.
    /// </summary>
    public partial class NetworkSecurityRuleStatus : Nutanix.Powershell.Models.INetworkSecurityRuleStatus, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        /// <summary>Creates an new <see cref="NetworkSecurityRuleStatus" /> instance.</summary>
        public NetworkSecurityRuleStatus()
        {
        }
    ...
    /// The status of a REST API call. Only used when there is a failure to
    /// report.
    public partial interface INetworkSecurityRuleStatus : Microsoft.Rest.ClientRuntime.IJsonSerializable {
