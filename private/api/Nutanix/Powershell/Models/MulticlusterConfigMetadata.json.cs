namespace Nutanix.Powershell.Models
{
    ...
    public partial class MulticlusterConfigMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Nutanix.Powershell.Models.IMulticlusterConfigMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Nutanix.Powershell.Models.IMulticlusterConfigMetadata.</returns>
        public static Nutanix.Powershell.Models.IMulticlusterConfigMetadata FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new MulticlusterConfigMetadata(json) : null;
        }
        /// <summary>
        /// Deserializes a Carbon.Json.JsonObject into a new instance of <see cref="MulticlusterConfigMetadata" />.
        /// </summary>
        /// <param name="json">A Carbon.Json.JsonObject instance to deserialize from.</param>
        internal MulticlusterConfigMetadata(Carbon.Json.JsonObject json)
        {
