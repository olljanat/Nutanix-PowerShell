namespace Nutanix.Powershell.Models
{
    ...
    /// </summary>
    public partial class VmRecoveryPointListMetadata
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Nutanix.Powershell.Models.IVmRecoveryPointListMetadata.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Nutanix.Powershell.Models.IVmRecoveryPointListMetadata.</returns>
        public static Nutanix.Powershell.Models.IVmRecoveryPointListMetadata FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new VmRecoveryPointListMetadata(json) : null;
        }
        /// <summary>
        /// Serializes this instance of <see cref="VmRecoveryPointListMetadata" /> into a <see cref="Carbon.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Carbon.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Microsoft.Rest.ClientRuntime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="VmRecoveryPointListMetadata" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a Carbon.Json.JsonObject into a new instance of <see cref="VmRecoveryPointListMetadata" />.
        /// </summary>
        /// <param name="json">A Carbon.Json.JsonObject instance to deserialize from.</param>
        internal VmRecoveryPointListMetadata(Carbon.Json.JsonObject json)
        {
            bool returnNow = false;
