namespace Nutanix.Powershell.Models
{
    ...
    public partial class SubnetListIntentResponse : Nutanix.Powershell.Models.ISubnetListIntentResponse, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        private Nutanix.Powershell.Models.ISubnetIntentResource[] _entities;

        public Nutanix.Powershell.Models.ISubnetIntentResource[] Entities
        {
            get
            {
        ...
        private Nutanix.Powershell.Models.ISubnetListMetadataOutput _metadata;

        /// <summary>
        /// All api calls that return a list will have this metadata block
        /// </summary>
        public Nutanix.Powershell.Models.ISubnetListMetadataOutput Metadata
        {
            get
            {
    ...
    public partial interface ISubnetListIntentResponse : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        ...
        Nutanix.Powershell.Models.ISubnetIntentResource[] Entities { get; set; }
        Nutanix.Powershell.Models.ISubnetListMetadataOutput Metadata { get; set; }
    }
}