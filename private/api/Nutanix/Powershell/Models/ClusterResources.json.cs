namespace Nutanix.Powershell.Models
{
    ...
    public partial class ClusterResources
    {
        ...
        internal ClusterResources(Carbon.Json.JsonObject json)
        {
            ...
            _config = If( json?.PropertyT<Carbon.Json.JsonObject>("config"), out var __jsonConfig) ? Nutanix.Powershell.Models.ClusterConfigSpec.FromJson(__jsonConfig) : Config;
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Nutanix.Powershell.Models.IClusterResources.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Nutanix.Powershell.Models.IClusterResources.</returns>
        public static Nutanix.Powershell.Models.IClusterResources FromJson(Carbon.Json.JsonNode node)
        {
