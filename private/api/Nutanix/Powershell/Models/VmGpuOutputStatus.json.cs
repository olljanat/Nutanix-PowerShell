namespace Nutanix.Powershell.Models
{
    ...
    public partial class VmGpuOutputStatus
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Nutanix.Powershell.Models.IVmGpuOutputStatus.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Nutanix.Powershell.Models.IVmGpuOutputStatus.</returns>
        public static Nutanix.Powershell.Models.IVmGpuOutputStatus FromJson(Carbon.Json.JsonNode node)
        {
