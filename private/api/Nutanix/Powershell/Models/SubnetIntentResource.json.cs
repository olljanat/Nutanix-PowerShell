namespace Nutanix.Powershell.Models
{
    ...
    public partial class SubnetIntentResource
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Carbon.Json.JsonNode"/> into an instance of Nutanix.Powershell.Models.ISubnetIntentResource.
        /// </summary>
        /// <param name="node">a <see cref="Carbon.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Nutanix.Powershell.Models.ISubnetIntentResource.</returns>
        public static Nutanix.Powershell.Models.ISubnetIntentResource FromJson(Carbon.Json.JsonNode node)
        {
        ...
        internal SubnetIntentResource(Carbon.Json.JsonObject json)
        {
            ...
            _status = If( json?.PropertyT<Carbon.Json.JsonObject>("status"), out var __jsonStatus) ? Nutanix.Powershell.Models.SubnetDefStatus.FromJson(__jsonStatus) : Status;
            AfterFromJson(json);
        }
        /// <summary>
