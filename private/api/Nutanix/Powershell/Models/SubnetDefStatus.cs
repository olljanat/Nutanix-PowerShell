namespace Nutanix.Powershell.Models
{
    ...
    public partial class SubnetDefStatus : Nutanix.Powershell.Models.ISubnetDefStatus, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        /// <summary>Any error messages for the subnet, if in an error state.</summary>
        ...
        private Nutanix.Powershell.Models.ISubnetResourcesDefStatus _resources;

        /// <summary>Subnet creation/modification status.</summary>
        public Nutanix.Powershell.Models.ISubnetResourcesDefStatus Resources
        {
            get
            {
        ...
        /// <summary>The state of the subnet.</summary>
        public string State
        {
            get
            {
        ...
        /// <summary>Creates an new <see cref="SubnetDefStatus" /> instance.</summary>
        public SubnetDefStatus()
        {
        }
    ...
    public partial interface ISubnetDefStatus : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        ...
        string Name { get; set; }
        Nutanix.Powershell.Models.ISubnetResourcesDefStatus Resources { get; set; }
