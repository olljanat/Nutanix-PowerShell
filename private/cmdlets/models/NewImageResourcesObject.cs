namespace Nutanix.Powershell.ModelCmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.IImageResources))]
    public class NewImageResourcesObject : System.Management.Automation.PSCmdlet
    {
        ...
        private Nutanix.Powershell.Models.IImageResources _imageResources = new Nutanix.Powershell.Models.ImageResources();
        /// <summary>
        ...
        public string ChecksumChecksumAlgorithm
        {
            set
            {
                _imageResources.Checksum = _imageResources.Checksum ?? new Nutanix.Powershell.Models.Checksum();
        ...
        public string ImageVersionResourcesProductName
        {
            set
            {
                _imageResources.Version = _imageResources.Version ?? new Nutanix.Powershell.Models.ImageVersionResources();
