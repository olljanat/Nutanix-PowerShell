namespace Nutanix.Powershell.ModelCmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.INetworkSecurityRuleResourcesQuarantineRule))]
    public class NewNetworkSecurityRuleResourcesQuarantineRuleObject : System.Management.Automation.PSCmdlet
    {
        ...
        private Nutanix.Powershell.Models.INetworkSecurityRuleResourcesQuarantineRule _networkSecurityRuleResourcesQuarantineRule = new Nutanix.Powershell.Models.NetworkSecurityRuleResourcesQuarantineRule();
        ...
        public string[] CategoryFilterKindList
        {
            set
            {
                _networkSecurityRuleResourcesQuarantineRule.TargetGroup = _networkSecurityRuleResourcesQuarantineRule.TargetGroup ?? new Nutanix.Powershell.Models.TargetGroup();
                _networkSecurityRuleResourcesQuarantineRule.TargetGroup.Filter = _networkSecurityRuleResourcesQuarantineRule.TargetGroup.Filter ?? new Nutanix.Powershell.Models.CategoryFilter();
