namespace Nutanix.Powershell.ModelCmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.INetworkSecurityRuleIntentInput))]
    public class NewNetworkSecurityRuleIntentInputObject : System.Management.Automation.PSCmdlet
    {
        ...
        private Nutanix.Powershell.Models.INetworkSecurityRuleIntentInput _networkSecurityRuleIntentInput = new Nutanix.Powershell.Models.NetworkSecurityRuleIntentInput();
        ...
        public string[] CategoryFilterKindList
        {
            set
            {
                _networkSecurityRuleIntentInput.Spec = _networkSecurityRuleIntentInput.Spec ?? new Nutanix.Powershell.Models.NetworkSecurityRule();
                _networkSecurityRuleIntentInput.Spec.Resources = _networkSecurityRuleIntentInput.Spec.Resources ?? new Nutanix.Powershell.Models.NetworkSecurityRuleResources();
                _networkSecurityRuleIntentInput.Spec.Resources.AppRule = _networkSecurityRuleIntentInput.Spec.Resources.AppRule ?? new Nutanix.Powershell.Models.NetworkSecurityRuleResourcesAppRule();
                _networkSecurityRuleIntentInput.Spec.Resources.AppRule.TargetGroup = _networkSecurityRuleIntentInput.Spec.Resources.AppRule.TargetGroup ?? new Nutanix.Powershell.Models.TargetGroup();
                _networkSecurityRuleIntentInput.Spec.Resources.AppRule.TargetGroup.Filter = _networkSecurityRuleIntentInput.Spec.Resources.AppRule.TargetGroup.Filter ?? new Nutanix.Powershell.Models.CategoryFilter();
        ...
        public string[] CategoryFilterKindList1
        {
            set
            {
                _networkSecurityRuleIntentInput.Spec = _networkSecurityRuleIntentInput.Spec ?? new Nutanix.Powershell.Models.NetworkSecurityRule();
                _networkSecurityRuleIntentInput.Spec.Resources = _networkSecurityRuleIntentInput.Spec.Resources ?? new Nutanix.Powershell.Models.NetworkSecurityRuleResources();
                _networkSecurityRuleIntentInput.Spec.Resources.IsolationRule = _networkSecurityRuleIntentInput.Spec.Resources.IsolationRule ?? new Nutanix.Powershell.Models.NetworkSecurityRuleResourcesIsolationRule();
                _networkSecurityRuleIntentInput.Spec.Resources.IsolationRule.FirstEntityFilter = _networkSecurityRuleIntentInput.Spec.Resources.IsolationRule.FirstEntityFilter ?? new Nutanix.Powershell.Models.CategoryFilter();
        ...
        public string[] CategoryFilterKindList2
        {
            set
            {
                ...
                _networkSecurityRuleIntentInput.Spec.Resources = _networkSecurityRuleIntentInput.Spec.Resources ?? new Nutanix.Powershell.Models.NetworkSecurityRuleResources();
                _networkSecurityRuleIntentInput.Spec.Resources.IsolationRule = _networkSecurityRuleIntentInput.Spec.Resources.IsolationRule ?? new Nutanix.Powershell.Models.NetworkSecurityRuleResourcesIsolationRule();
                _networkSecurityRuleIntentInput.Spec.Resources.IsolationRule.SecondEntityFilter = _networkSecurityRuleIntentInput.Spec.Resources.IsolationRule.SecondEntityFilter ?? new Nutanix.Powershell.Models.CategoryFilter();
        ...
        public string[] CategoryFilterKindList3
        {
            set
            {
                _networkSecurityRuleIntentInput.Spec = _networkSecurityRuleIntentInput.Spec ?? new Nutanix.Powershell.Models.NetworkSecurityRule();
                _networkSecurityRuleIntentInput.Spec.Resources = _networkSecurityRuleIntentInput.Spec.Resources ?? new Nutanix.Powershell.Models.NetworkSecurityRuleResources();
                _networkSecurityRuleIntentInput.Spec.Resources.QuarantineRule = _networkSecurityRuleIntentInput.Spec.Resources.QuarantineRule ?? new Nutanix.Powershell.Models.NetworkSecurityRuleResourcesQuarantineRule();
                _networkSecurityRuleIntentInput.Spec.Resources.QuarantineRule.TargetGroup = _networkSecurityRuleIntentInput.Spec.Resources.QuarantineRule.TargetGroup ?? new Nutanix.Powershell.Models.TargetGroup();
                _networkSecurityRuleIntentInput.Spec.Resources.QuarantineRule.TargetGroup.Filter = _networkSecurityRuleIntentInput.Spec.Resources.QuarantineRule.TargetGroup.Filter ?? new Nutanix.Powershell.Models.CategoryFilter();
