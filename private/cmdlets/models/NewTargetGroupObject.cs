namespace Nutanix.Powershell.ModelCmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ITargetGroup))]
    public class NewTargetGroupObject : System.Management.Automation.PSCmdlet
    {
        ...
        private Nutanix.Powershell.Models.ITargetGroup _targetGroup = new Nutanix.Powershell.Models.TargetGroup();
        ...
        public string[] CategoryFilterKindList
        {
            set
            {
                _targetGroup.Filter = _targetGroup.Filter ?? new Nutanix.Powershell.Models.CategoryFilter();
